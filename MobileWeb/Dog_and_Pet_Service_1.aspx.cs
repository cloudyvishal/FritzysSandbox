...
namespace MobileWeb
{
    public partial class Dog_and_Pet_Service_1 : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindData((int)(Enumeration.ServiceId.DOG_AND_PET_SERVICE_ONE_SERVICEID), (int)(Enumeration.ServiceId.COMMON_PAGE_ID));
            }
        }
