...
namespace MobileWeb
{
    public partial class Dog_and_Pet_Flea_and_Tick : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindData((int)(Enumeration.ServiceId.DOG_AND_PET_FLEA_AND_TICK_SERVICEID), (int)(Enumeration.ServiceId.COMMON_PAGE_ID));
            }
        }
