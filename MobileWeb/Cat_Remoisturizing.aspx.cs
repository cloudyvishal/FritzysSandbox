...
namespace MobileWeb
{
    public partial class Cat_Remoisturizing : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindData((int)(Enumeration.ServiceId.MOBILEWEB_CAT_REMOISTURIZING_SERVICEID), (int)(Enumeration.ServiceId.COMMON_PAGE_ID));
            }
        }
