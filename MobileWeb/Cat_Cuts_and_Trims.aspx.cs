...
namespace MobileWeb
{
    public partial class Cat_Cuts_and_Trims : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindData((int)(Enumeration.ServiceId.MOBILEWEB_CAT_BRUSHOUT_SERVICEID), (int)(Enumeration.ServiceId.COMMON_PAGE_ID));
            }
        }
