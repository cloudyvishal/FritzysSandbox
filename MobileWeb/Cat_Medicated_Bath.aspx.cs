...
namespace MobileWeb
{
    public partial class Cat_Medicated_Bath : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindData((int)(Enumeration.ServiceId.MOBILEWEB_CAT_DE_SHEDDING_SERVICEID), (int)(Enumeration.ServiceId.COMMON_PAGE_ID));
            }
        }
