...
namespace MobileWeb
{
    public partial class Cat_ValentinesDay : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindData((int)(Enumeration.ServiceId.CAT_VALENTINESDAY_SERVICEID), (int)(Enumeration.ServiceId.COMMON_PAGE_ID));
            }
        }
