            ...
            <div id="wrapper">
                ...
                <div id="mainInnerContent">
                    ...
                    <div id="innerLeftPannel">
                        ...
                        <div class="title">
                            <asp:Image ID="aboutustitle" ImageUrl="http://localhost:50372/Images/aboutusTitle.jpg" runat="server" AlternateText="" />
                        </div>
                        <div class="leftInner">
                            <div class="aboutinnerleft">
                                <asp:Image ID="leftimage" ImageUrl="http://localhost:50372/Images/aboutusImg1.jpg" runat="server" AlternateText="" />
                            </div>
                        ...
                        <div class="title">
                            <asp:Image ID="patecarepro" ImageUrl="http://localhost:50372/Images/petcareprosTitle.jpg" runat="server" AlternateText="" />
                        </div>
                        <div class="leftInner">
                            <div class="petcareBg">
                                <asp:DataList ID="dtlNews" DataKeyField="NewsID" runat="server" RepeatColumns="2" Width="100%" OnItemDataBound="dtlNews_ItemDataBound" CellPadding="0" CellSpacing="0">
                                    <ItemTemplate>
                                        <div class="news">
                                            <div class="images">
                                                <asp:Image ID="Image1" ImageUrl="http://localhost:50372/Images/patecareListImg.gif" runat="server" AlternateText="" />
                                            </div>
                        ...
                        <div class="titleBar">
                            <asp:Image ID="pagetitle" ImageUrl="http://localhost:50372/Images/pageTitle.jpg" runat="server" AlternateText="" />
                        </div>
                        <div class="leftInner">
