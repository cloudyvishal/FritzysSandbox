...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <![endif]-->
    <script type="text/javascript" src="http://naturesfreshpet.com/Scripts/phone_validation.js"></script>
    <script type="text/javascript" src="http://naturesfreshpet.com/Scripts/Validation.js"></script>
            ...
            <div id="wrapper">
                ...
                <div id="mainInnerContent">
                    ...
                    <div id="innerLeftPannel">
                        ...
                        <div class="HomeleftInner">
                            <div class="innerPannelLeft">
                                <div class="innerTitle">
                                    <img src="http://naturesfreshpet.com/Images/for_your_dogs_title.jpg" alt="Mobile Grooming, Grooming, Mobile Pet Grooming" />
                                </div>
                                <div class="left1">
                            ...
                            <div class="innerPannelRight">
                                <div class="innerTitle">
                                    <asp:Image ID="forcats" ImageUrl="http://naturesfreshpet.com/Images/for_your_cats_title.jpg" runat="server" AlternateText="" />
                                </div>
                                <div class="left">
                        ...
                        <div class="title">
                            <asp:Image ID="productHeader" ImageUrl="http://naturesfreshpet.com/Images/products_title.jpg" runat="server" AlternateText="" />
                        </div>
                        <div class="HomeleftInner">
                            <PR:Product ID="Pro" runat="server" />
                        </div>
                        <div class="titleBar">
                            <img src="http://naturesfreshpet.com/Images/content_shadow3.jpg" width="668" height="39" alt="" />
                        </div>
                        <div class="leftInner">
                        ...
                        <div class="img1">
                           ...
                           <div >
                                <asp:ImageButton ID="imgbtnMakePayment" runat="server"  
                                    ImageUrl="http://naturesfreshpet.com/Images/makepayment.gif"  Width="236px" Height="100px" 
                                    onclick="imgbtnMakePayment_Click" Visible="false"/>
                                <asp:ImageButton ID="btnPaid" runat="server"  ImageUrl="http://naturesfreshpet.com/Images/paid.png" Visible="false"/>
                            </div>
                            ...
                            <div class="img">
                                <a href="comingsoon.aspx" title="GROOMERS BLOG">
                                    <img src="http://naturesfreshpet.com/btn_groomers_blog.jpg" border="0" alt="GROOMERS BLOG" class="groomersBlogImg" /></a>
                            </div>
                            <div class="img">
                                <a href="comingsoon.aspx" title="PET LOVERS BLOG">
                                    <img src="http://naturesfreshpet.com/btn_pet_lovers_blog.jpg" width="234" height="78" border="0" alt="PET LOVERS BLOG" /></a>
                            </div>
