<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ViewUsers.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ViewUsers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        ...
        <img src="http://naturesfreshpet.com/Images/seperator.jpg" alt="" />
        <br />
        <br />
        <h3>Pet Details</h3>
                        ...
                        <td>
                            <table cellpadding="3" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="Label9" runat="server" Text='<%# Bind("StyleName") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr style="background: #f7f2ea; height: 25px;">
                                    <td colspan="2">
                                        <asp:LinkButton Text="Delete" ToolTip="Delete" CssClass="petlink" CommandName="Delete" OnClientClick="return Validate();" CommandArgument='<%# Bind("PetID") %>'
                                            runat="server" ID="delete" />
                                        &nbsp;
                                        <asp:HyperLink ID="hypEdit" runat="server" Text="Edit" ToolTip="Edit" CssClass="petlink" NavigateUrl='<%# "EditPet.aspx?PetID=" +  Eval("PetID") + "&ID=" + Request.QueryString["ID"].ToString() + "&p=" + Request.QueryString["p"].ToString()  %>'></asp:HyperLink>
                                    </td>
                                </tr>
                            </table>
                        </td>
        ...
        <asp:GridView ID="grdAppointment" runat="server" CellPadding="0" GridLines="Vertical" DataKeyNames="AppointmentID"
            Width="100%" HeaderStyle-CssClass="headerStyle" AutoGenerateColumns="false" CssClass="gridStyle itemstyle"
            AlternatingRowStyle-CssClass="altGridStyle" AllowPaging="true" AllowSorting="true" PageSize="5"
            OnSorting="grdAppointment_Sorting" OnPageIndexChanging="grdAppointment_PageIndexChanging">
            <AlternatingRowStyle CssClass="altGridStyle" />
            <PagerStyle CssClass="gridPager" />
            <Columns>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphFooter" runat="server">
    <script type="text/javascript" src="../Script/Phone_Validation.js"></script>
