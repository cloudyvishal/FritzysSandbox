<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddAgent.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.AddAgent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        ...
        <asp:Button ID="AddUser" runat="server" Text="Add Agent" ToolTip="Add Agent" CssClass="btnBg"
