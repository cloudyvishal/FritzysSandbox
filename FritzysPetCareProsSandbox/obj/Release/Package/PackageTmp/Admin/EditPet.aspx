<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditPet.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.EditPet" %>
                ...
                <td>
                    ...
                    <div class="apptDrpDiv">
                        <asp:ListBox ID="lstAddservices1" runat="server" CssClass="apptListbox" SelectionMode="Multiple"
                            Style="display: none;" OnClick="return SetText(1);" onblur="return HideList(1);"></asp:ListBox>
                    </div>
                </td>
            </tr>
        </table>
