<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageLocations.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ManageLocations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        ...
        <asp:GridView ID="GrdLocationService" runat="server" DataKeyNames="ZipCodeID" AutoGenerateColumns="False"
            ...
            CellPadding="0" CellSpacing="0" GridLines="Vertical" Width="100%" OnDataBound="GrdLocationService_DataBound"
            OnRowCreated="GrdLocationService_RowCreated" OnSorting="GrdLocationService_Sorting"
        ...
        <asp:Button ID="btnAdd" runat="server" Text="Add Service Location" CssClass="btnBg"
            ToolTip="Add Service Location" PostBackUrl="~/Admin/AddServiceLocation.aspx" />
        ...
        <asp:Button ID="btnExport" runat="server" Text="Export" CssClass="btnBg" ToolTip="Export"
            OnClick="btnExport_Click" />
        <asp:Button ID="btnImport" runat="server" Text="Import" CssClass="btnBg" OnClientClick="return ShowDiv();"
            ToolTip="Import" />
        <div id="divShow" runat="server" style="display: none; margin: 10px 0 0 0;" class="itemstyle">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnUpload" Text="Upload" runat="server" CssClass="servbtnBg" border="0"
        ...
        <asp:Button ID="lnkNorec" runat="server" CssClass="btnBg" Text="Go Back" Visible="false"
            OnClick="lnkNorec_Click" />
    </div>
</asp:Content>
