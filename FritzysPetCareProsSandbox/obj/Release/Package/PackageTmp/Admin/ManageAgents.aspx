<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageAgents.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ManageAgents" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        ...
        <asp:GridView ID="GrdUser" runat="server" DataKeyNames="UserID" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:HyperLinkField SortExpression="Username" ItemStyle-CssClass="itemstyle manageuser"
                    HeaderStyle-CssClass="headerStyle" DataNavigateUrlFields="UserID" DataNavigateUrlFormatString="EditAgent.aspx?UserId={0}"
        ...
        <asp:Button ID="btnAdd" runat="server" Text="Add Agent" CssClass="btnBg" ToolTip="Add Agent"
            PostBackUrl="~/Admin/AddAgent.aspx" />
