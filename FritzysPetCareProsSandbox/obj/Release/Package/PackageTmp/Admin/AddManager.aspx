<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddManager.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.AddManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="Cust1" runat="server" Display="None" ControlToValidate="txtPassword"
                        ...
                        ErrorMessage="<b>Required Field Missing</b><br />Password length should not be less than 6 characters">
                    </asp:CustomValidator>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtConfirmPassword"
                        Display="None" SetFocusOnError="true" ErrorMessage="<b>Required Field Missing</b><br />Confirm Password is required.">  
                    </asp:RequiredFieldValidator>
                    <asp:CustomValidator ID="CustomValidator1" runat="server" Display="None" ControlToValidate="txtConfirmPassword"
                        SetFocusOnError="true" ClientValidationFunction="CheckConfirmPassword" ErrorMessage="<b>Required Field Missing</b><br />Password and confirm password should be same">
                    </asp:CustomValidator>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtEmail"
                        Display="None" SetFocusOnError="true" ErrorMessage="<b>Required Field Missing</b><br />Email is required.">  
                    </asp:RequiredFieldValidator>
        ...
        <asp:Button ID="AddUser" runat="server" Text="Add Manager" ToolTip="Add Manager" CssClass="btnBg"
            OnClick="AddUser_Click" />
        <asp:Button ID="btnBack" runat="server" Text="Cancel" ToolTip="Cancel" CssClass="btnBg"
            CausesValidation="false" PostBackUrl="~/Admin/ManageManager.aspx?SearchFor=0&SearchText=" />
    </div>
</asp:Content>
