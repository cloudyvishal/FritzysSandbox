<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageUser.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ManageUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        ...
        <asp:GridView ID="GrdUser" runat="server" DataKeyNames="UserID" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:HyperLinkField SortExpression="Username" ItemStyle-CssClass="itemstyle manageuser"
                    ...
                    DataTextField="Username" HeaderText="Username"></asp:HyperLinkField>
        ...
        <asp:Button ID="btnAdd" runat="server" Text="Add User" CssClass="btnBg" ToolTip="Add User"
            PostBackUrl="~/Admin/AddUser.aspx" />
