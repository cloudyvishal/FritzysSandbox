<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageServices.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ManageServices" %>
        ...
        <asp:GridView ID="GrdService" runat="server" DataKeyNames="ServiceID" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Order" Visible="false">
                    ...
                    <HeaderStyle CssClass="headerStyle" />
                    <ItemTemplate>
                        <asp:Label ID="lblServiceID1" runat="server" Text='<%# Bind("ServiceID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
        <div class="itemstyle" id="divSelectpet" runat="server">
            ...
            <div id="divPet" runat="server">
                <table border="0" style="margin: 10px 0pt 0pt;" class="setservPage">
                    <tr>
                        <td style="width: 130px; font-size: 12px;">Please select pet :
                        </td>
                        <td>
                ...
                <table>
                    <tr>
                        <td colspan="3" style="height: 138px">
                            <asp:ListBox ID="lstOrder" runat="server" CssClass="setorderListbox" Rows="10" SelectionMode="Multiple"></asp:ListBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
