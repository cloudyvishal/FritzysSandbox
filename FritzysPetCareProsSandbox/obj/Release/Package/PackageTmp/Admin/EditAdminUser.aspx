<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditAdminUser.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.EditAdminUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlType" runat="server">
                        ...
                        <asp:ListItem Text="Sub Admin" Value="1"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
        ...
        <asp:Button ID="btnBack" runat="server" CssClass="btnBg" Text="Cancel" ToolTip="Cancel"
            CausesValidation="false" PostBackUrl="~/Admin/ManageUser.aspx?SearchFor=0&SearchText=" />
    </div>
</asp:Content>
