<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditService.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.EditService" %>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="btnUpload" runat="server" CausesValidation="false" Text="Upload"
                        ToolTip="Upload" CssClass="btnBg" OnClick="btnUpload_Click" />&nbsp;
                    <br />
