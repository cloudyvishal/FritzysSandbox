<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.AdminHome" %>
            ...
            <asp:GridView ID="grdContactUs" runat="server" AutoGenerateColumns="False" CellPadding="0"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Message" SortExpression="Message">
                        ...
                        <ItemTemplate>
                            <div class="contactOverflow">
                                <asp:Label ID="lblImage" runat="server" Text='<%# Bind("Message") %>'></asp:Label>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <asp:GridView ID="grdAppointment" runat="server" DataKeyNames="UserID" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Name">
                        ...
                        <HeaderStyle CssClass="headerStyle" />
                        <ItemTemplate>
                            <asp:HyperLink ID="hypUser" runat="server" Text='<%# Bind("FullName")  %>'
                                NavigateUrl='<%# "ViewUsers.aspx?ID=" + Eval("UserID") + "&p=0" %>'></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
