<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="FritzysPetCareProsSandbox.Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntBody" runat="server">
            ...
            <div id="wrapper">
                ...
                <div id="mainInnerContent">
                    ...
                    <div id="innerLeftPannel">
                        ...
                        <div class="flashImg">
                            <asp:Image ID="aboutusbanner" ImageUrl="http://naturesfreshpet.com//Images/aboutusBanner.jpg" runat="server" AlternateText=" " />

                        </div>
                        <div class="title">
                            <asp:Image ID="BlankTitle" ImageUrl="http://naturesfreshpet.com//Images/content_shadow3.jpg" runat="server" AlternateText=" " />
                        </div>

                        <div class="leftInner">
                            <div id="loginMainpage">
                                <div id="contactRightTop"></div>
                                    ...
                                    <div class="loginPage">
                                        <table width="80%" border="0" cellpadding="3" cellspacing="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender1"
                                                            TargetControlID="RequiredFieldValidator1" HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 84px">
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="valSuggest" ControlToValidate="txtPassword"
                                                            Display="None" SetFocusOnError="true" ErrorMessage="<b>Required Field Missing</b><br />Password is required.">  
                                                        </asp:RequiredFieldValidator>
                                                        <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender2"
                                                            TargetControlID="RequiredFieldValidator2" HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:CheckBox ID="chkRemember" runat="server" />Remember me on this computer</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" style="height: 17px">
                                                        <asp:ImageButton ID="btnLogin" runat="server" ToolTip="LOGIN" ImageUrl="http://naturesfreshpet.com//Images/loginbtn.jpg" ValidationGroup="valSuggest" OnClick="btnLogin_Click1" /></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <p>
                                                            <asp:LinkButton ID="lnkForgotPassword" CausesValidation="false" runat="server" Text="Forgot Password?" ToolTip="Forgot Password?" CssClass="friendsLink" />
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="2">Not a Member?&nbsp;&nbsp;<asp:ImageButton ID="RegisterNow" runat="server" ToolTip="REGISTER NOW" ImageUrl="http://naturesfreshpet.com/Images/regesterImg.jpg" ValidationGroup="valSuggest" /></td>
                                                </tr>
                    ...
                    <div id="innerRightPannel">
                        ...
                        <div class="img">
                            <div class="locationServiced">
                                ...
                                <div class="gobutton">
                                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="http://naturesfreshpet.com/Images/btn_go.gif"
                                        AlternateText="Go" />
                                </div>
                            </div>
                            <div class="img">
                                <a href="#" title="It's Free Join Fritzy's Club">
                                    <img src="http://naturesfreshpet.com/Images/join_fritzys_club.jpg" border="0" alt="It's Free Join Fritzy's Club" /></a>
                            </div>
                            <div class="img">
                                <a href="#" title="Make an appointment Now">
                                    <img src="http://naturesfreshpet.com/Images/make_appointment_now.jpg" border="0" alt="Make an appointment Now" /></a>
                            </div>
                            <div class="imgGiftcard">
                                <a href="#" title="Fritzy's giftcard">
                                    <img src="http://naturesfreshpet.com/Images/giftcard1.jpg" border="0" alt="Fritzy's GiftCard" /></a>
                            </div>
                            <div class="img">
                            ...
                            <div class="img">
                                <div class="sugesstionBox">
                                    <asp:ImageButton ID="btnSuggestion" runat="server" ImageUrl="http://naturesfreshpet.com/Images/btn_suggestion_box_bg.jpg" />
    ...
    <cc1:ModalPopupExtender ID="ModalPopupExtender5" runat="server" TargetControlID="lnkForgotPassword"
        PopupControlID="PanelFiveImg" BackgroundCssClass="modalBackground" OnCancelScript="return SetEmpty();" CancelControlID="closewindow">
    ...
    <asp:Panel Style="display: none" ID="PanelFiveImg" runat="server">
        <table width="200px" border="1">
            <tbody>
                <tr>
                    <td align="right">
                        <asp:ImageButton ID="closewindow" ImageUrl="http://naturesfreshpet.com/Images/closeImg.jpg" runat="server" CausesValidation="false" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="revEmail" runat="server" Display="None" ErrorMessage="<b>Required Field Missing</b><br />Please enter correct email."
                            SetFocusOnError="true" ValidationGroup="valSubmit" ControlToValidate="txtEmail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">
                        </asp:RegularExpressionValidator>
                        <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender0"
                            TargetControlID="RequiredFieldValidator3" HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                ...
                <tr>
                    <td>
                        <asp:ImageButton ID="btnSumbmit" runat="server" OnClick="btnSumbmit_Click" ImageUrl="http://naturesfreshpet.com/Images/submitbutton.jpg"
