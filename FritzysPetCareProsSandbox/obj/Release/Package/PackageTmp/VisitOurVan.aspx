                        ...
                        <div class="vanleftInner">
                            <div class="vanInner">
                                <div id="slideshow" style="width: 100%; background: none;">
                                    <img src="http://naturesfreshpet.com/StoreData/VisitVan/2.jpg" />
                                </div>
                            ...
                            <div class="title">
                                <asp:Image ID="vanImgShadow" ImageUrl="http://naturesfreshpet.com/Images/vanImgShadow.jpg" runat="server"
                                    AlternateText="" />
                            </div>
                            <div class="leftInner">
                                <div class="vanTitle">
                                    <asp:Image ID="fullsalonheader" ImageUrl="http://naturesfreshpet.com/Images/fullsalonHeader.jpg" runat="server"
                                        AlternateText="" />
                                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntFooter" runat="server">
    <script type="text/javascript" language="javascript" defer="defer">
        ...
        var def_imges1 = new Array('StoreData/VisitVan/2.jpg', 'StoreData/VisitVan/3.jpg', 'StoreData/VisitVan/4.jpg');
        //****************************************************************
