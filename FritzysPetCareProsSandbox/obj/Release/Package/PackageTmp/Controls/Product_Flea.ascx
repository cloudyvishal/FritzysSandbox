<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Product_Flea.ascx.cs" Inherits="FritzysPetCarePros.Controls.Product_Flea" %>
<div class="ServicesInnerDatalistDiv">
    <%--  Data list is use to bind all services of cat Start --%>
    <asp:DataList ID="dlProducts" runat="server" RepeatColumns="2" Width="100%"
        CellPadding="0" RepeatDirection="Vertical"
        CellSpacing="0" OnItemDataBound="dlProducts_ItemDataBound">
        <ItemTemplate>
            <div class="innerPannelLeft">
                <div class="left1">
                    <img alt="Image Product" src="#" runat="server" id="ImgProduct" />
                ...
                <div class="right">
                    ...
                    <br />
                    <br />
                    <a href="Contactus.aspx" title="Buy">
                        <img src="http://naturesfreshpet.com/Images/btn_buy.gif" width="53" height="20" alt="Buy" />
                    </a>
                </div>
            </div>
        </ItemTemplate>
