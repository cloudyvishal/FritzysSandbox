            ...
            <div class="cart">
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <div class="go">
                                <asp:ImageButton ID="btnSearchLogout" runat="server" ImageUrl="http://naturesfreshpet.com/Images/btn_go.gif"
...
<asp:Panel Style="display: none" ID="PanelFiveImg" runat="server">
    <div id="loginOuter">
        <div id="loginMain">
            <div id="loginHeader">
                <div id="loginLogo">
                    <asp:Image ID="Image1" ImageUrl="http://naturesfreshpet.com/Images/loginLogo.jpg" runat="server" AlternateText="" />
                </div>
                <div id="loginTitle">
                ...
                <div class="loginRight">
                    <table width="100%" border="0" cellpadding="3">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:ImageButton ID="btnLogin" runat="server" ValidationGroup="valLogin" ImageUrl="http://naturesfreshpet.com/Images/loginbtn.jpg"
                                ...
                                <td>
                                    ...
                                    <div id="divForgot" runat="server" style="display: none; border: 1px solid #baa080; margin: 0 0 10px 0;">
                                        <table border="0" width="100%">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:ImageButton ID="ImgSubmitForgot1" runat="server" ImageUrl="http://naturesfreshpet.com/Images/submitbutton.jpg"
