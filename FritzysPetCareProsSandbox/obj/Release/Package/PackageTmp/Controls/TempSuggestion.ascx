<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TempSuggestion.ascx.cs" Inherits="FritzysPetCarePros.Controls.TempSuggestion" %>
...
<a id="linkBlog" title="Fritzy's pet care pros : Blog" runat="server" style="cursor: pointer;">Blog</a>
...
<asp:Panel Style="display: block" ID="PanelFiveImg" runat="server">
    <div style="border: 2px solid #6d5c45;">
        <div id="suggestionpopup">
            <div class="popupleft">
                <asp:Image ID="popupimg" ImageUrl="http://naturesfreshpet.com/Images/popupImg.jpg" runat="server" AlternateText=" " />
            </div>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" SetFocusOnError="true"
                                                        ControlToValidate="txtName" Display="None" ValidationGroup="ValTempSuggestion" ErrorMessage="<b>Required Field Missing</b><br />Name is required.">  
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" SetFocusOnError="true"
                                                        ControlToValidate="txtComment" Display="None" ValidationGroup="ValTempSuggestion" ErrorMessage="<b>Required Field Missing</b><br />Comment is required.">  
                                                    </asp:RequiredFieldValidator>
