<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchFriend.ascx.cs" Inherits="FritzysPetCarePros.Controls.SearchFriend" %>
<asp:UpdatePanel ID="upFriends" runat="server">
    <ContentTemplate>

        <div style="width: 640px;">
            <p>
                <asp:Label ID="lblTitleFriend" runat="server"></asp:Label>
            </p>
            <asp:DataList ID="dlFriends" runat="server" RepeatColumns="1" Width="100%" CellPadding="0">
                <ItemTemplate>
                    <div class="friends">
                        <div class="imagesfriends">
                            <asp:Image ID="Image1" ImageUrl='<%# "~/" + "StoreData/FriendLogo/" + Eval("Logo") %>'
            ...
            <div class="prevNext" id="divprevNext" runat="server">
                <ul>
                    <li>
                        <asp:LinkButton ID="lnkFriendPrev" runat="server" Text="Previous" OnClick="prevFriendlink_Click"
                            CssClass="prevlink" ToolTip="Previous"></asp:LinkButton></li>
                    <li>
                        <asp:Label ID="lblFriendLine" runat="server" Text="|"></asp:Label>
                    </li>
                    <li>
                        <asp:LinkButton ID="lnkFriendNext" runat="server" Text="Next" OnClick="lnkFriendNext_Click" ToolTip="Next"
