<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Product.ascx.cs" Inherits="FritzysPetCarePros.Controls.Product" %>
    ...
    <asp:DataList ID="dlProducts" runat="server" RepeatColumns="2" Width="100%"
        ...
        <ItemTemplate>
            <div class="innerPannelLeft">
                <div class="left1">
                    <img alt="Dog Supplies,Cat Supplies" src="#" runat="server" id="ImgProduct" />
                ...
                <div class="right">
                    ...
                    <a href="Contactus.aspx" title="Buy">
                        <img src="http://naturesfreshpet.com/Images/btn_buy.gif" width="53"
                            height="20" alt="Buy" />
                    </a>
                </div>
            </div>
