...
<asp:Panel Style="display: none" ID="PanelFiveImg" runat="server">
    <div style="border: 2px solid #6d5c45;">
        <div id="suggestionpopup">
            <div class="popupleft">
                <asp:Image ID="popupimg" ImageUrl="../Images/popupImg.jpg" runat="server" AlternateText=" " />
            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="closewindow">
                                                    <asp:ImageButton ID="closewindow" ImageUrl="http://naturesfreshpet.com/Images/closeImg.jpg" runat="server" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Image ID="suggestionboxheader" ImageUrl="http://naturesfreshpet.com/Images/suggestionBoxHeader.jpg" runat="server" AlternateText=" " /></td>
                                            </tr>
                                            <tr>
                                                <td>
