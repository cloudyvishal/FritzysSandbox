<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Services_Common.ascx.cs" Inherits="FritzysPetCarePros.Controls.Services_Common" %>
<style type="text/css">
    .prevlink {
        color: #503414;
        font-size: 12px;
...
<div class="leftInner">
    <div class="ServicesinnerPannelLeft">
        <div class="innerTitle">
            <img src="http://naturesfreshpet.com/Images/for_your_dogs_title.jpg" alt="Dog Grooming, Cat Grooming" />
        </div>
    ...
    <div class="ServicesinnerMidPannel">
        <asp:Image ID="imgDivider" ImageUrl="http://naturesfreshpet.com/Images/midDivider.jpg" runat="server" AlternateText=" " />
    </div>
    <div class="ServicesinnerPannelRight">
        <div class="innerTitle">
            <asp:Image ID="forcats" ImageUrl="http://naturesfreshpet.com/Images/for_your_cats_title.jpg" runat="server"
                AlternateText=" " />
        </div>
        <div class="topDatalistDiv">
            <div class="left">
                ...
                <ContentTemplate>
                    <asp:DataList ID="dlCat" runat="server" RepeatColumns="1" Width="100%" CellPadding="0"
                        ...
                        <ItemTemplate>
                            <div class="news">
                                <div class="servicesImages">
                                    <asp:Image ID="Image1" ImageUrl="http://naturesfreshpet.com/Images/catPaw.jpg" runat="server" AlternateText=" " />
                                </div>
                                <div class="overflowDiv">
                                    <asp:HyperLink ID="hypService" CssClass="newstitle" runat="server" NavigateUrl='<%#"~/" + Eval("ServicePageNames") %>'
                                        Text='<%#Eval("ServiceTitle") %>'></asp:HyperLink>
