<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TestZip.ascx.cs" Inherits="FritzysPetCarePros.Controls.TestZip" %>
...
<div class="locationServiced" onkeypress="javascript:return FormPanel_FireDefaultButtonZip(event,'ctl00_ContentPlaceHolder1_ctlZipcode_imgZipcode')">
    <div class="zipcode">
        <asp:TextBox ID="txtZip" runat="server" CssClass="textfieldZip" Height="15px" OnClick="return SetZipText();" OnFocus="return SetZipText();"
        ...
        <asp:CustomValidator runat="server" ID="custSpChar" ValidationGroup="valZip"
            ControlToValidate="txtZip" Display="None" SetFocusOnError="true"
            ClientValidationFunction="ValidateCharZip"
        ...
        <asp:RegularExpressionValidator ID="RegValZip" runat="server" Display="None"
            ErrorMessage="<b>Required Field Missing</b><br />Please enter correct zipcode ." ValidationGroup="valZip"
    ...
    <div>
        <asp:ImageButton ID="imgZipcode" runat="server" CssClass="gobtn" ImageUrl="http://naturesfreshpet.com/Images/btn_go.gif" ValidationGroup="valZip" AlternateText="Go" ToolTip="Go" OnClick="imgZipcode_Click" />
    </div>
...
<cc1:ModalPopupExtender ID="ModelZip" runat="server" TargetControlID="btnTest"
    PopupControlID="PanelFiveImg" BackgroundCssClass="modalBackground" CancelControlID="imgClose" OnCancelScript="ClearZip()">
...
<asp:Panel Style="display: none" ID="PanelFiveImg" runat="server" CssClass="zipPopupDiv">
    <table class="zipmodalPopup" border="0">
        <tbody>
            <tr>
                <td align="right">
                    <asp:ImageButton ID="imgClose" runat="server" ImageUrl="http://naturesfreshpet.com/Images/closeImgButton.jpg" />
                </td>
            </tr>
            <tr>
                        ...
                        <table width="100%" border="0">
                            <tbody>
                                <tr>
                                    <td>
                                        <h5>
                                            <asp:Label ID="lblZipcode" runat="server"></asp:Label></h5>
