<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Login.ascx.cs" Inherits="FritzysPetCarePros.Controls.Login" %>
...
<cc1:ModalPopupExtender ID="ModalLogin" runat="server" TargetControlID="ImgAppointment" PopupControlID="PanelFiveImg"
            ...
            <div id="loginHeader">
                ...
                <div id="loginTitle">
                    <div class="closeLoginWindow">
                        <asp:Image ID="closeLoginWindow" ImageUrl="http://naturesfreshpet.com/Images/closeImg.jpg" runat="server"
                            AlternateText="" />
                    </div>
                    <div class="loginTitle">
                        <asp:Image ID="Image2" ImageUrl="http://naturesfreshpet.com/Images/loginTitle.gif" runat="server" AlternateText="" />
                    </div>
                </div>
            </div>
            <div class="loginLeft">
                <asp:Image ID="loginleftimage" ImageUrl="http://naturesfreshpet.com/Images/loginLeftImg.jpg" runat="server"
                    AlternateText="" />
            </div>
                ...
                <table width="100%" border="0" cellpadding="3">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtUsername" runat="server" CssClass="logintextField" ValidationGroup="valLoginAppointment"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPassword" runat="server" CssClass="logintextField" TextMode="Password"
                                    ValidationGroup="valLoginAppointment"></asp:TextBox>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:ImageButton ID="btnLogin" runat="server" ValidationGroup="valLoginAppointment" ImageUrl="~/Images/loginbtn.jpg"
            ...
            <div class="loginRight" onkeypress="javascript:return FormPanel_FireDefaultButton(event,'ctl00_ctl04_ImgSubmitForgot')">
                <table>
                    <tbody>
                            ...
                            <td colspan="2">
                                ...
                                <div id="divForgot" runat="server" style="display: none; border: 1px solid #baa080; margin: 0 0 10px 0;">
                                    <table border="0" width="100%">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:ImageButton ID="ImgSubmitForgot" runat="server" ImageUrl="http://naturesfreshpet.com/Images/submitbutton.jpg"
                        ...
                        <tr>
                            <td colspan="2" class="notreg">Not a Member?&nbsp;&nbsp;
                                <asp:ImageButton ID="RegisterNow" runat="server" ImageUrl="http://naturesfreshpet.com/Images/regesterImg.jpg"
