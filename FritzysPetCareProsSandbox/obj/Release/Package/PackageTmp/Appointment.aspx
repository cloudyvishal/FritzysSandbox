            ...
            <div id="wrapper">
                ...
                <div id="mainInnerContent">
                    ...
                    <div id="regMain">
                        ...
                        <div id="regTitle">
                            <asp:Image ID="ImgScheduled" ImageUrl="http://naturesfreshpet.com/Images/regScheduleTitle.jpg" runat="server" />
                        </div>
                            ...
                            <div class="regFormMid">
                                <div class="ApptForm" onkeypress="javascript:return FormPanel_FireDefaultButton(event,'ctl00_ContentPlaceHolder1_IdNext')">
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Image ID="IdWhoWhat" ImageUrl="http://naturesfreshpet.com/Images/reg_who_what_title.jpg" runat="server" /></td>
                                        </tr>
                                    </table>
                                    <table cellspacing="6" border="0">
                                        ...
                                        <tr id="p1" runat="server">
                                            ...
                                            <td>
                                                <asp:ImageButton ID="imgDelete1" runat="server" Visible="false"
                                                    ImageUrl="http://naturesfreshpet.com/Images/deleteicon.gif" ToolTip="Delete" OnClick="imgDelete1_Click" OnClientClick="return confirmation();" /></td>
                                        </tr>
                                        ...
                                        <tr id="p3" runat="server">
                                            ...
                                            <td>
                                                <asp:ImageButton ID="imgDelete3" runat="server" Visible="false"
                                                    ImageUrl="http://naturesfreshpet.com/Images/deleteicon.gif" ToolTip="Delete" OnClick="imgDelete3_Click" OnClientClick="return confirmation();" /></td>
                                        </tr>
                                        <tr id="p4" runat="server">
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <asp:ImageButton ID="ImgAdservices4" runat="server" ImageUrl="http://naturesfreshpet.com/Images/DDImage.bmp" OnClientClick="return setList(4);" CssClass="imgbutton" />
                                                </div>
                                                <div class="apptDrpDiv">
                                            ...
                                            <td>
                                                <asp:ImageButton ID="imgDelete4" runat="server" Visible="false"
                                                    ImageUrl="http://naturesfreshpet.com/Images/deleteicon.gif" ToolTip="Delete" OnClick="imgDelete4_Click" OnClientClick="return confirmation();" /></td>
                                        </tr>
                                        ...
                                        <tr id="p5" runat="server">
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <asp:ImageButton ID="ImgAdservices5" runat="server" ImageUrl="http://naturesfreshpet.com/Images/DDImage.bmp" OnClientClick="return setList(5);" CssClass="imgbutton" />
                                                </div>
                                                <div class="apptDrpDiv">
                                            ...
                                            <td>
                                                <asp:ImageButton ID="imgDelete5" runat="server" Visible="false"
                                                    ImageUrl="http://naturesfreshpet.com/Images/deleteicon.gif" ToolTip="Delete" OnClick="imgDelete5_Click" OnClientClick="return confirmation();" /></td>
                                        </tr>
                                        <tr id="p6" runat="server">
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <asp:ImageButton ID="ImgAdservices6" runat="server" ImageUrl="http://naturesfreshpet.com/Images/DDImage.bmp" OnClientClick="return setList(6);" CssClass="imgbutton" />
                                                </div>
                                                <div class="apptDrpDiv">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="8">
                                                ...
                                                <asp:ImageButton ID="imgAddmore" ImageUrl="http://naturesfreshpet.com/Images/regAddpetbtn.jpg" runat="server" OnClick="imgAddmore_Click" CausesValidation="true" ValidationGroup="valPet" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="8">
                                                <asp:ImageButton ID="ImageButton1" ImageUrl="http://naturesfreshpet.com/Images/regEDitbtn.jpg" runat="server" OnClick="ImageButton3_Click" /></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="8">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Image ID="ImgWhenTitle" runat="server" ImageUrl="http://naturesfreshpet.com/Images/reg_when_title.jpg" /></td>
                                    </tr>
                                    </table>
                                    ...
                                    <table class="calendertable">
                                        <tr>
                                            <td colspan="2" class="paddingforcalender">
                                                ...
                                                <asp:ImageButton ID="imgCalPop" runat="server" ImageUrl="http://naturesfreshpet.com/Images/calImage.jpg" Visible="false" />
                                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="MM/d/yyyy" PopupButtonID="imgCalPop"
                                                    TargetControlID="txtSelectDate" OnClientDateSelectionChanged="SetDropdown">
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Image ID="Image1" runat="server" ImageUrl="http://naturesfreshpet.com/Images/reg_where_title.jpg" /></td>
                                        </tr>
                                    </table>
                                    <table cellspacing="8">
                                        <tr>
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Image ID="Image2" runat="server" ImageUrl="http://naturesfreshpet.com/Images/reg_confirmby.jpg" /></td>
                                        </tr>
                                    </table>
                                    <table cellspacing="8">
                                        <tr>
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Image ID="Image3" runat="server" ImageUrl="http://naturesfreshpet.com/Images/reg_notes.jpg" /></td>
                                        </tr>
                                    </table>
                                    <table cellspacing="8">
                                        <tr>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="left" style="padding-left: 5px;">
                                                <asp:ImageButton ID="IdNext" ImageUrl="http://naturesfreshpet.com/Images/regScheduleBtn.jpg" runat="server" OnClick="IdNext_Click" />
