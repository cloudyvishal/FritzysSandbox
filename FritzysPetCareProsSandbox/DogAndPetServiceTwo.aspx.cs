...
{
    public partial class DogAndPetServiceTwo : BasePage
    {
        int ServiceId = 103;
        int pageid = 1;
            ...
            try
            {
                    ...
                    new[]
                {
                    ...
                    if (Ismobile.Equals(true))
                    {
                        ...
                        string p = repData.Replace("/", "/fritzymobile/").ToLower();

                        //Response.Redirect("http://localhost:50372/fritzymobile/".ToLower());
