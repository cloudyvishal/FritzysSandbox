<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="FritzysPetCareProsSandbox.Registration" %>
                        ...
                        <div class="regForm">
                            ...
                            <div class="regFormMid">
                                <div class="regestrationForm" onkeypress="javascript:return FormPanel_FireDefaultButton(event,'ctl00_ContentPlaceHolder1_IdSubmit')">
                                    ...
                                    <table cellspacing="4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtStreet"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Street name is required."
                                                    Display="None" ValidationGroup="valReg_Basic" runat="server" SetFocusOnError="true">  
                                                </asp:RequiredFieldValidator>
                                                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender49" TargetControlID="RequiredFieldValidator1"
                                                    HighlightCssClass="validatorCalloutHighlight" Enabled="true" runat="Server" />
                                            </td>
                                            <td>
                                                <table>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender50" TargetControlID="RequiredFieldValidator2"
                                                                HighlightCssClass="validatorCalloutHighlight" Enabled="true" runat="Server" />
                                                        </td>
                                                        <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="txtZip"
                                                    ErrorMessage="<b>Required Field Missing</b><br />ZIP is required."
                                                    Display="None" ValidationGroup="valReg_Basic" runat="server" SetFocusOnError="true">  
                                                </asp:RequiredFieldValidator>
                                                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender51" TargetControlID="RequiredFieldValidator3"
                                                    HighlightCssClass="validatorCalloutHighlight" Enabled="true" runat="Server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPhone" CssClass="regTextField" runat="server" onkeydown="javascript:backspacerDOWN(this,event);"
                                                    onkeyup="javascript:backspacerUP(this,event);" MaxLength="15"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td class="tdstyle">
                                    ...
                                    <table cellspacing="4" id="tblAlternate" runat="server" visible="false">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <asp:TextBox ID="txtAltPhone" CssClass="regTextField" runat="server" MaxLength="15"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td class="tdstyle">
                                                <label>
                                        ...
                                        <ContentTemplate>
                                            <table cellspacing="8">
                                                ...
                                                <tr id="p1" runat="server">
                                                    <td>1.</td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlPetType1" CssClass="regddlField" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType1_OnSelectedIndexChanged">
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="ReqVal1" ControlToValidate="txtPetName1"
                                                            ErrorMessage="<b>Required Field Missing</b><br />Pet name is required."
                                                            Display="None" ValidationGroup="valReg_Basic" runat="server" SetFocusOnError="true">  
                                                        </asp:RequiredFieldValidator>
                                                        <cc1:ValidatorCalloutExtender ID="VCEPet1" TargetControlID="ReqVal1"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" runat="Server" />
                                                    </td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlBreed1" CssClass="regddlFieldbig" runat="server"></asp:DropDownList>
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAl2"
                                                            Text="Selcect One"
                                                            InitialValue="0"
                                                            ControlToValidate="ddlBreed1"
                                                            ErrorMessage="<b>Required Field Missing</b><br />Breed is required"
                                                            Display="none"
                                                            ValidationGroup="valReg_Basic" runat="server" SetFocusOnError="true" />
                                                        <cc1:ValidatorCalloutExtender ID="VCEPet2" TargetControlID="ReqVal2"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" runat="Server" />
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtPetDOB1" CssClass="regTextFldbyear" runat="server" MaxLength="4"></asp:TextBox>
                                                        <asp:CompareValidator ID="CompareValidator1" runat="server" ValueToCompare="0" ControlToValidate="txtPetDOB1"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender52" TargetControlID="CompareValidator1"
                                                        ...
                                                        <cc1:ValidatorCalloutExtender
                                                            ID="VCEPet3"
                                                            TargetControlID="ReqVal3"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" runat="Server" />

                                                        <asp:RegularExpressionValidator ID="ReqPet4" runat="server" Display="None"
                                                            ErrorMessage="<b>Required Field Missing</b><br />Please enter correct birth year ." ValidationGroup="valReg_Basic"
                                                            SetFocusOnError="true" ControlToValidate="txtPetDOB1" ValidationExpression="\d{4}"></asp:RegularExpressionValidator>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPetWeight1" CssClass="regTextFldstate" runat="server" MaxLength="6"></asp:TextBox>&nbsp;lbs
                                                        <asp:CompareValidator ID="CompareValidator12" runat="server" ValueToCompare="0" ControlToValidate="txtPetWeight1"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender63" TargetControlID="CompareValidator12"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="Reqval4"
                                                            ControlToValidate="txtPetWeight1"
                                                            ErrorMessage="<b>Required Field Missing</b><br />Weight is required."
                                                            ValidationGroup="valReg_Basic"
                                                            Display="None" runat="server" SetFocusOnError="true">  
                                                        </asp:RequiredFieldValidator>
                                                        <cc1:ValidatorCalloutExtender
                                                            ID="VCEPet4"
                                                            TargetControlID="Reqval4"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" runat="Server" />

                                                        <asp:RegularExpressionValidator ID="ReqPet6" runat="server" Display="None"
                                                            ErrorMessage="<b>Required Field Missing</b><br />Please enter correct Weight." ValidationGroup="valReg_Basic"
                                                            SetFocusOnError="true" ControlToValidate="txtPetWeight1" ValidationExpression="^\d*(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="VCEPet5" TargetControlID="ReqPet6"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />

                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtPetLength1" MaxLength="6" CssClass="regTextFldflength" runat="server"></asp:TextBox>&nbsp;inches
                                                         <asp:CompareValidator ID="CompareValidator13" runat="server" ValueToCompare="0" ControlToValidate="txtPetLength1"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender64" TargetControlID="CompareValidator13"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="Reqval7"
                                                            ControlToValidate="txtPetLength1"
                                                            ErrorMessage="<b>Required Field Missing</b><br />Length is required."
                                                            ValidationGroup="valReg_Basic"
                                                            Display="None" runat="server" SetFocusOnError="true">  
                                                        </asp:RequiredFieldValidator>
                                                        <cc1:ValidatorCalloutExtender
                                                            ID="VCEPet6"
                                                            TargetControlID="Reqval7"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" runat="Server" />

                                                        <asp:RegularExpressionValidator ID="Reqval8" runat="server" Display="None"
                                                            ErrorMessage="<b>Required Field Missing</b><br />Please enter correct length." ValidationGroup="valReg_Basic"
                                                            SetFocusOnError="true" ControlToValidate="txtPetLength1" ValidationExpression="^\d*(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                                ...
                                                <tr id="p2" runat="server">
                                                    <td>2.</td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlPetType2" CssClass="regddlField" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType2_OnSelectedIndexChanged">
                                                            <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                                            <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlBreed2" CssClass="regddlFieldbig" runat="server"></asp:DropDownList>
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAl22"
                                                            Text="Selcect One"
                                                            InitialValue="0"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDOB2" CssClass="regTextFldbyear" runat="server" MaxLength="4"></asp:TextBox>
                                                        <asp:CompareValidator ID="CompareValidator2" runat="server" ValueToCompare="0" ControlToValidate="txtDOB2"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender53" TargetControlID="CompareValidator2"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAl23"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPetWeight2" CssClass="regTextFldstate" runat="server" MaxLength="5"></asp:TextBox>&nbsp;lbs
                                                        <asp:CompareValidator ID="CompareValidator11" runat="server" ValueToCompare="0" ControlToValidate="txtPetWeight2"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender62" TargetControlID="CompareValidator11"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAl24"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPetLength2" CssClass="regTextFldflength" runat="server" MaxLength="5"></asp:TextBox>&nbsp;inches
                                                         <asp:CompareValidator ID="CompareValidator14" runat="server" ValueToCompare="0" ControlToValidate="txtPetLength2"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender65" TargetControlID="CompareValidator14"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAl25"
                                                ...
                                                <tr id="p3" runat="server">
                                                    <td>3.</td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlPetType3" CssClass="regddlField" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType3_OnSelectedIndexChanged">
                                                            <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                                            <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlBreed3" CssClass="regddlFieldbig" runat="server"></asp:DropDownList>
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAl32"
                                                            Text="Selcect One"
                                                            InitialValue="0"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDOB3" CssClass="regTextFldbyear" runat="server" MaxLength="4"></asp:TextBox>
                                                        <asp:CompareValidator ID="CompareValidator3" runat="server" ValueToCompare="0" ControlToValidate="txtDOB3"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender54" TargetControlID="CompareValidator3"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAL33"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPetWeight3" CssClass="regTextFldstate" runat="server" MaxLength="5"></asp:TextBox>&nbsp;lbs
                                                        <asp:CompareValidator ID="CompareValidator10" runat="server" ValueToCompare="0" ControlToValidate="txtPetWeight3"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender61" TargetControlID="CompareValidator10"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAl34"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPetLength3" CssClass="regTextFldflength" runat="server" MaxLength="5"></asp:TextBox>&nbsp;inches
                                                         <asp:CompareValidator ID="CompareValidator15" runat="server" ValueToCompare="0" ControlToValidate="txtPetLength3"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender66" TargetControlID="CompareValidator15"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAL35"
                                                ...
                                                <tr id="p4" runat="server">
                                                    <td>4.</td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlPetType4" CssClass="regddlField" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType4_OnSelectedIndexChanged">
                                                            <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                                            <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlBreed4" CssClass="regddlFieldbig" runat="server"></asp:DropDownList>
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAl42"
                                                            Text="Selcect One"
                                                            InitialValue="0"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDOB4" CssClass="regTextFldbyear" runat="server" MaxLength="4"></asp:TextBox>
                                                        <asp:CompareValidator ID="CompareValidator4" runat="server" ValueToCompare="0" ControlToValidate="txtDOB4"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender55" TargetControlID="CompareValidator4"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAL43"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPetWeight4" CssClass="regTextFldstate" runat="server" MaxLength="5"></asp:TextBox>&nbsp;lbs
                                                        <asp:CompareValidator ID="CompareValidator9" runat="server" ValueToCompare="0" ControlToValidate="txtPetWeight4"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender60" TargetControlID="CompareValidator9"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAl44"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPetLength4" CssClass="regTextFldflength" runat="server" MaxLength="5"></asp:TextBox>&nbsp;inches
                                                         <asp:CompareValidator ID="CompareValidator16" runat="server" ValueToCompare="0" ControlToValidate="txtPetLength4"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender67" TargetControlID="CompareValidator16"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAL45"
                                                ...
                                                <tr id="p5" runat="server">
                                                    <td>5.</td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlPetType5" CssClass="regddlField" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType5_OnSelectedIndexChanged">
                                                            <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                                            <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlBreed5" CssClass="regddlFieldbig" runat="server"></asp:DropDownList>
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAl52"
                                                            Text="Selcect One"
                                                            InitialValue="0"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDOB5" CssClass="regTextFldbyear" runat="server" MaxLength="4"></asp:TextBox>
                                                        <asp:CompareValidator ID="CompareValidator5" runat="server" ValueToCompare="0" ControlToValidate="txtDOB5"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender56" TargetControlID="CompareValidator5"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAL53"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPetWeight5" CssClass="regTextFldstate" runat="server" MaxLength="5"></asp:TextBox>&nbsp;lbs
                                                         <asp:CompareValidator ID="CompareValidator8" runat="server" ValueToCompare="0" ControlToValidate="txtPetWeight5"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender59" TargetControlID="CompareValidator8"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAl54"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPetLength5" CssClass="regTextFldflength" runat="server" MaxLength="5"></asp:TextBox>&nbsp;inches
                                                         <asp:CompareValidator ID="CompareValidator17" runat="server" ValueToCompare="0" ControlToValidate="txtPetLength5"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender68" TargetControlID="CompareValidator17"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAL55"
                                                ...
                                                <tr id="p6" runat="server">
                                                    <td>6.</td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlPetType6" CssClass="regddlField" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType6_OnSelectedIndexChanged">
                                                            <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                                            <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlBreed6" CssClass="regddlFieldbig" runat="server"></asp:DropDownList>
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAl62"
                                                            Text="Selcect One"
                                                            InitialValue="0"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDOB6" CssClass="regTextFldbyear" runat="server" MaxLength="4"></asp:TextBox>
                                                        <asp:CompareValidator ID="CompareValidator6" runat="server" ValueToCompare="0" ControlToValidate="txtDOB6"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender57" TargetControlID="CompareValidator6"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAL63"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPetWeight6" CssClass="regTextFldstate" runat="server" MaxLength="5"></asp:TextBox>&nbsp;lbs
                                                        <asp:CompareValidator ID="CompareValidator7" runat="server" ValueToCompare="0" ControlToValidate="txtPetWeight6"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender58" TargetControlID="CompareValidator7"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                         <asp:RequiredFieldValidator
                                                             ID="ReqVAl64"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPetLength6" CssClass="regTextFldflength" runat="server" MaxLength="5"></asp:TextBox>&nbsp;inches
                                                         <asp:CompareValidator ID="CompareValidator18" runat="server" ValueToCompare="0" ControlToValidate="txtPetLength6"
                                                            ErrorMessage="Must enter positive integers" Operator="GreaterThan" Type="Integer" Display="None"></asp:CompareValidator>
                                                        <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender69" TargetControlID="CompareValidator18"
                                                            HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                        <asp:RequiredFieldValidator
                                                            ID="ReqVAL65"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5">
                                                        ...
                                                        <asp:ImageButton ID="imgAddmore" ImageUrl="~/Images/addMorepetButton.jpg" runat="server" ValidationGroup="valPet" CausesValidation="true" OnClick="imgAddmore_Click" /></td>
                                                </tr>
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Image ID="ImgUserName" ImageUrl="~/Images/creatusertitle.jpg" runat="server" /></td>
                                        </tr>
                                    </table>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <asp:TextBox ID="txtEmailReg" CssClass="regTextField" runat="server" ValidationGroup="valReg_Basic" MaxLength="30"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <asp:TextBox ID="txtConPasswordReg" TextMode="Password" CssClass="regTextField" runat="server" MaxLength="15" ValidationGroup="valReg_Basic"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <cc1:ValidatorCalloutExtender runat="Server" ID="VCE9" TargetControlID="ReqConfirmReg"
                                                    HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="left">
                                                ...
                                                <asp:ImageButton ID="IdReset" ImageUrl="~/Images/regResetbtn.jpg" runat="server" CausesValidation="false" OnClick="IdReset_Click" />
                                            </td>
                                            <td align="right" style="padding-right: 10px;">
                                                <table>
                                                    <tr>
                                                        <td colspan="2" class="tdstylemend">Note:</td>
                                                    </tr>
                                                    <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntFooter" runat="server">
    <script type="text/javascript" lang="javascript" src="Scripts/Validation.js" defer="defer"></script>
