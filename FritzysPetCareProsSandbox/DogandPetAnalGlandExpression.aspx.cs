...
{
    public partial class DogandPetAnalGlandExpression : BasePage
    {
        int ServiceId = 86;
        int pageid = 1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                    ...
                    new[]
                {
                    ...
                    {
                        Response.Redirect("http://localhost:50372/fritzymobile/Dog_and_Pet_Anal_Gland_Expression.aspx".ToLower());
                        HttpContext.Current.Response.Status = "301 Moved Permanently";
                        HttpContext.Current.Response.AddHeader("Location", Request.Url.ToString().Replace("http://localhost:50372/", "http://www.localhost:50372/fritzymobile/Dog_and_Pet_Anal_Gland_Expression.aspx"));
