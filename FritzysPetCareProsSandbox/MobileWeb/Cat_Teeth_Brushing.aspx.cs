...
namespace MobileWeb
{
    public partial class Cat_Teeth_Brushing : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindData((int)(Enumeration.ServiceId.CAT_TEETH_BRUSHING_SERVICEID), (int)(Enumeration.ServiceId.COMMON_PAGE_ID));
            }
        }
