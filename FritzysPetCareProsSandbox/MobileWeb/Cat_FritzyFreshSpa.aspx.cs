...
namespace MobileWeb
{
    public partial class Cat_FritzyFreshSpa : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindData((int)(Enumeration.ServiceId.CAT_FRITZYFRESHSPA_SERVICEID), (int)(Enumeration.ServiceId.COMMON_PAGE_ID));
            }
        }
