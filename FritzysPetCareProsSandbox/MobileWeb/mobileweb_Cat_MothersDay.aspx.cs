...
namespace MobileWeb
{
    public partial class mobileweb_Cat_MothersDay : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindData((int)(Enumeration.ServiceId.MOBILEWEB_CAT_MOTHERSDAY_SERVICEID), (int)(Enumeration.ServiceId.COMMON_PAGE_ID));
            }
        }
