<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Inner_Page_MB_MasterPage.Master" AutoEventWireup="true" CodeBehind="MB_ServiceDetails.aspx.cs" Inherits="MobileWeb.MB_ServiceDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="contentinnersection">
        ...
        <div class="ServicesMidDiv">
            ...
            <span id="divDogService" runat="server">
                <b>
