...
namespace MobileWeb
{
    public partial class Cat_Pad_Treatment : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindData((int)(Enumeration.ServiceId.CAT_PAD_TREATMENT_SERVICEID), (int)(Enumeration.ServiceId.COMMON_PAGE_ID));
            }
        }
