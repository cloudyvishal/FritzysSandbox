...
namespace MobileWeb
{
    public partial class MB_Schedule_Appointment : BasePage
    {
        string PetTypeID = "0";
    ...
    */
        ...
        protected void IdNext_Click(object sender, EventArgs e)
        {
            ...
            if (isvalid == true)
            {
                ...
                dt = Convert.ToDateTime(ddlMonth.SelectedValue + "/" + dddDay.SelectedValue + "/" + ddlYear.SelectedValue);

                TimeSpan ts = dt.Date - DateTime.Now; ;

                string str123 = ddlMonth.SelectedValue + "/" + dddDay.SelectedValue + "/" + ddlYear.SelectedValue;

                string str1232 = ddlMonth.SelectedValue + "/" + dddDay.SelectedValue + "/" + ddlYear.SelectedValue + " " + ddlhr.SelectedItem.Text;
                ...
                if ((dt1.Date > DateTime.Now) && (ViewState["IsPet"].ToString() != "0"))
                {
                    ...
                    if (dvPet1.Visible == true)
                    {
                        if ((txtPetName1.Text.Trim() != "") && (txtPetDOB1.Text.Trim() != "") && (txtPetWeight1.Text.Trim() != "") && (txtPetLength1.Text.Trim() != ""))
                        {
                            ...
                            if (PetID1.Text == "0")
                            {
                                for (int i = 0; i < lstAddservices1.Items.Count; i++)
                                {
                                    if (lstAddservices1.Items[i].Selected)
                                    {
                                        lstAddservices1.ClearSelection();

                                        string text = lstAddservices1.Items[i].Value;

                                        txtAddServicesID1.Text = text;
                                    }
                                }
                    ...
                    if (dvPet2.Visible == true)
                    {
                        if ((txtPetName2.Text.Trim() != "") && (txtDOB2.Text.Trim() != "") && (txtPetWeight2.Text.Trim() != "") && (txtPetLength2.Text.Trim() != ""))
                        {
                            ...
                            if (PetID2.Text == "0")
                            {
                                for (int i = 0; i < lstAddservices2.Items.Count; i++)
                                {
                                    if (lstAddservices2.Items[i].Selected)
                                    {
                                        lstAddservices2.ClearSelection();
                                        string text1 = lstAddservices2.Items[i].Value;
                                        txtAddServicesID2.Text = text1;
                                    }
                                }
                            ...
                            else
                            {
                                for (int i = 0; i < lstAddservices2.Items.Count; i++)
                                {
                                    ...
                                    {
                                        lstAddservices2.ClearSelection();
                                        string text1 = lstAddservices1.Items[i].Value;
                                        txtAddServicesID2.Text = text1;
                                    }
                                }
                    ...
                    if (dvPet3.Visible == true)
                    {
                        if ((txtPetName3.Text.Trim() != "") && (txtDOB3.Text.Trim() != "") && (txtPetWeight3.Text.Trim() != "") && (txtPetLength3.Text.Trim() != ""))
                        {
                            ...
                            if (PetID3.Text == "0")
                            {
                                for (int i = 0; i < lstAddservices3.Items.Count; i++)
                                {
                                    if (lstAddservices3.Items[i].Selected)
                                    {
                                        lstAddservices3.ClearSelection();
                                        string text3 = lstAddservices1.Items[i].Value;
                                        txtAddServicesID3.Text = text3;
                                    }
                                }
                            ...
                            else
                            {
                                for (int i = 0; i < lstAddservices3.Items.Count; i++)
                                {
                                    ...
                                    {
                                        lstAddservices3.ClearSelection();
                                        string text3 = lstAddservices3.Items[i].Value;
                                        txtAddServicesID3.Text = text3;
                                    }
                                }
                    ...
                    if (dvPet4.Visible == true)
                    {
                        if ((txtPetName4.Text.Trim() != "") && (txtDOB4.Text.Trim() != "") && (txtPetWeight4.Text.Trim() != "") && (txtPetLength4.Text.Trim() != ""))
                        {
                            ...
                            if (PetID4.Text == "0")
                            {
                                for (int i = 0; i < lstAddservices4.Items.Count; i++)
                                {
                                    if (lstAddservices4.Items[i].Selected)
                                    {
                                        lstAddservices4.ClearSelection();
                                        string text4 = lstAddservices4.Items[i].Value;
                                        txtAddServicesID4.Text = text4;
                                    }
                                }
                    ...
                    if (dvPet5.Visible == true)
                    {
                        if ((txtPetName5.Text.Trim() != "") && (txtDOB5.Text.Trim() != "") && (txtPetWeight5.Text.Trim() != "") && (txtPetLength5.Text.Trim() != ""))
                        {
                            ...
                            if (PetID5.Text == "0")
                            {
                                for (int i = 0; i < lstAddservices5.Items.Count; i++)
                                {
                                    if (lstAddservices5.Items[i].Selected)
                                    {
                                        lstAddservices5.ClearSelection();
                                        string text5 = lstAddservices5.Items[i].Value;
                                        txtAddServicesID5.Text = text5;
                                    }
                                }
                    ...
                    if (dvPet6.Visible == true)
                    {
                        if ((txtPetName6.Text.Trim() != "") && (txtDOB6.Text.Trim() != "") && (txtPetWeight6.Text.Trim() != "") && (txtPetLength6.Text.Trim() != ""))
                        {
                            ...
                            if (PetID6.Text == "0")
                            {
                                for (int i = 0; i < lstAddservices6.Items.Count; i++)
                                {
                                    if (lstAddservices6.Items[i].Selected)
                                    {
                                        lstAddservices6.ClearSelection();
                                        string text6 = lstAddservices6.Items[i].Value;
                                        txtAddServicesID6.Text = text6;
                                    }
                                }
                    ...
                    lblErrorDate.Text = "Your Appointment Scheduled Successfully.";
            ...
            else { lblErrorDate.Text = "Invalid Date! Please Select Valid Date."; }
        }
        ...
        */
        public int CheckStatus()
        {
            int c = 0;
            int d = 0;
            if ((dvPet1.Visible == true) && (ViewState["IsPet"] != "0"))
            {
        ...
        */
        ...
        {
            Response.Redirect("MB_registration_update.aspx");
        }
        #endregion
