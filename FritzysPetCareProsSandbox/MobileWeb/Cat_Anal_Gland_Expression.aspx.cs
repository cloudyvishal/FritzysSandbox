...
namespace MobileWeb
{
    public partial class Cat_Anal_Gland_Expression : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindData((int)(Enumeration.ServiceId.CAT_ANAL_GLAND_EXPRESSION_SERVICEID), (int)(Enumeration.ServiceId.COMMON_PAGE_ID));
            }
        }
