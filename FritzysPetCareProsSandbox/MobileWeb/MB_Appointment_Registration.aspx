<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Inner_Page_MB_MasterPage.Master" AutoEventWireup="true" CodeBehind="MB_Appointment_Registration.aspx.cs" Inherits="MobileWeb.MB_Appointment_Registration" %>
    ...
    <div class="contentinnersection">
        ...
        <div class="innercontent">
            <div class="reg-top-txt">
                Join Fritzy's Club today, and enjoy member discounts, online appointment requests and more.  Please complete the information below so you can login as a member the next time you visit our site.
            </div>
            ...
            <div class="forform">
                <form action="#">
                    ...
                    <asp:TextBox runat="server" CssClass="txtbox" MaxLength="12" ID="txtPhone"></asp:TextBox><br />
                    ...
                    <h2><span class="heading">Your Pet Information</span></h2>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="divfirstpetinfo" id="dvPet1" runat="server">
                                <div class="petlabeldiv">
                                    ...
                                    <asp:DropDownList ID="ddlPetType1" CssClass="shortselectbox" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType1_OnSelectedIndexChanged">
                            ...
                            <div class="divfirstpetinfo" id="dvPet2" runat="server">
                                <div class="petlabeldiv">
                                    ...
                                    <asp:DropDownList ID="ddlPetType2" CssClass="shortselectbox" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType2_OnSelectedIndexChanged">
                                        <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            ...
                            <div class="divfirstpetinfo" id="dvPet3" runat="server">
                                <div class="petlabeldiv">
                                    ...
                                    <asp:DropDownList ID="ddlPetType3" CssClass="shortselectbox" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType3_OnSelectedIndexChanged">
                                        <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            ...
                            <div class="divfirstpetinfo" id="dvPet4" runat="server">
                                <div class="petlabeldiv">
                                    ...
                                    <asp:DropDownList ID="ddlPetType4" CssClass="shortselectbox" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType4_OnSelectedIndexChanged">
                                        <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            ...
                            <div class="divfirstpetinfo" id="dvPet5" runat="server">
                                <div class="petlabeldiv">
                                    ...
                                    <asp:DropDownList ID="ddlPetType5" CssClass="shortselectbox" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType5_OnSelectedIndexChanged">
                                        <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            ...
                            <div class="divfirstpetinfo" id="dvPet6" runat="server">
                                <div class="petlabeldiv">
                                    ...
                                    <asp:DropDownList ID="ddlPetType6" CssClass="shortselectbox" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType5_OnSelectedIndexChanged">
                                        <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                    ...
                    <asp:Button ID="imgAddmore" CssClass="button" runat="server" Text="Add More Pet" CausesValidation="true" OnClick="imgAddmore_Click" /><br />
                    <br />
                    <h2><span class="heading">Create Username &amp; Password</span></h2>
                    <asp:Label runat="server" ID="username" CssClass="label">Email<span class="mand">*</span></asp:Label><br />
                    <asp:TextBox CssClass="txtbox" ID="txtEmailReg" MaxLength="30" runat="server"></asp:TextBox><br />
                    <asp:Label runat="server" ID="passwordlabel" CssClass="label">Password<span class="mand">*</span></asp:Label><br />
                    <asp:TextBox runat="server" ID="txtPasswordReg" MaxLength="30" CssClass="txtbox"></asp:TextBox><br />
                    <asp:Label runat="server" ID="cnfpassword" CssClass="label">Confirm Password<span class="mand">*</span></asp:Label><br />
                    <asp:TextBox runat="server" ID="txtcnfpassword" MaxLength="30" CssClass="txtbox"></asp:TextBox><br />
                    <asp:Button runat="server" ID="IdSubmit" CssClass="button" Text="Submit" OnClientClick="return validate();" OnClick="IdSubmit_Click" />&nbsp;&nbsp;
