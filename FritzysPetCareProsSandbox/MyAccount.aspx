<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="MyAccount.aspx.cs" Inherits="FritzysPetCareProsSandbox.MyAccount" %>
            ...
            <div id="wrapper">
                ...
                <div id="mainInnerContent">
                    ...
                    <div id="regMain">
                        ...
                        <!-- reg top end here -->
                        <div id="regTitle">
                            <asp:Image ID="ImgTitle" ImageUrl="~/Images/additionalInfo.jpg" runat="server" AlternateText="" />
                        </div>
                        <div class="regForm">
                                ...
                                <div class="regestrationForm">
                                    ...
                                    <table cellspacing="4">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <asp:TextBox ID="txtAltContact" CssClass="regTextField" runat="server" MaxLength="30"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="tdstyle">
                                        ...
                                        <tr>
                                            <td class="tdstyle">
                                                <label>
                                                    Referral Source <span>*</span></label>
                                            </td>
                                            <td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="p1" runat="server">
                                                        ...
                                                        <td>
                                                            ...
                                                            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender6" runat="Server" TargetControlID="ReqVal2"
                                                                Enabled="true" HighlightCssClass="validatorCalloutHighlight">
                                                            </cc1:ValidatorCalloutExtender>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtPetDOB1" runat="server" MaxLength="4" CssClass="regTextFldbyear"></asp:TextBox>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPetWeight1" runat="server" MaxLength="6" CssClass="regTextFldstate"></asp:TextBox>&nbsp;lbs
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPetLength1" runat="server" MaxLength="6" CssClass="regTextFldflength"></asp:TextBox>&nbsp;inches
                                                    ...
                                                    <tr id="p2" runat="server">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDOB2" runat="server" MaxLength="4" CssClass="regTextFldbyear"></asp:TextBox>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPetWeight2" runat="server" MaxLength="5" CssClass="regTextFldstate"></asp:TextBox>&nbsp;lbs
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPetLength2" runat="server" MaxLength="5" CssClass="regTextFldflength"></asp:TextBox>&nbsp;inches
                                                    ...
                                                    <tr id="p3" runat="server">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDOB3" runat="server" MaxLength="4" CssClass="regTextFldbyear"></asp:TextBox>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPetWeight3" runat="server" MaxLength="5" CssClass="regTextFldstate"></asp:TextBox>&nbsp;lbs
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPetLength3" runat="server" MaxLength="5" CssClass="regTextFldflength"></asp:TextBox>&nbsp;inches
                                                    ...
                                                    <tr id="p4" runat="server">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDOB4" runat="server" MaxLength="4" CssClass="regTextFldbyear"></asp:TextBox>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPetWeight4" runat="server" MaxLength="5" CssClass="regTextFldstate"></asp:TextBox>&nbsp;lbs
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPetLength4" runat="server" MaxLength="5" CssClass="regTextFldflength"></asp:TextBox>&nbsp;inches
                                                    ...
                                                    <tr id="p5" runat="server">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDOB5" runat="server" MaxLength="4" CssClass="regTextFldbyear"></asp:TextBox>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPetWeight5" runat="server" MaxLength="5" CssClass="regTextFldstate"></asp:TextBox>&nbsp;lbs
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPetLength5" runat="server" MaxLength="5" CssClass="regTextFldflength"></asp:TextBox>&nbsp;inches
                                                    ...
                                                    <tr id="p6" runat="server">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtDOB6" runat="server" MaxLength="4" CssClass="regTextFldbyear"></asp:TextBox>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPetWeight6" runat="server" MaxLength="5" CssClass="regTextFldstate"></asp:TextBox>&nbsp;lbs
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPetLength6" runat="server" MaxLength="5" CssClass="regTextFldflength"></asp:TextBox>&nbsp;inches
                                    ...
                                    <table width="100%" border="0">
                                        <tr>
                                            <td align="left" style="padding-left: 25px; width: 12%;">
                                                <asp:ImageButton ID="IdNext" ImageUrl="~/Images/updatebtn.gif" runat="server" ValidationGroup="valReg_Basic"
                                                    CausesValidation="true" OnClick="IdNext_Click" />
                                            </td>
                                            <td>
                                                <asp:ImageButton ID="IdReset" Visible="true" ImageUrl="~/Images/setAppBtn.gif" runat="server"
                                                    OnClick="IdReset_Click" ValidationGroup="valReg_Basic" CausesValidation="true" />
                                            </td>
                                    ...
                                    <table width="100%" border="0">
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <br />
                                                <br />
                                                <asp:Label ID="lblFutureApp" runat="server" Text="Future Appointments" Font-Bold="true"
                                                    Font-Size="Medium" ForeColor="#009ddc"> </asp:Label>
                                            </td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <asp:GridView ID="GrdUsers" runat="server" DataKeyNames="AppointmentID" AutoGenerateColumns="False"
                                                    ...
                                                    OnRowDataBound="GrdUsers_RowDataBound" OnDataBound="GrdUsers_DataBound" PageSize="10"
                                                    ...
                                                    OnSorting="GrdUsers_Sorting" OnRowDeleting="GrdUsers_RowDeleting">
                                                    <PagerTemplate>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Start Time">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbltxtExpectedPetTime" runat="server" Text='<%# Bind("T","{0:hh}")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Address">
                                                            <ItemStyle CssClass="itemstyle" />
                                                            <HeaderStyle CssClass="headerStyle" Width="180px" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblStatus" runat="server" Text='<%# Bind("Address")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Full Name">
                                                            <ItemStyle CssClass="itemstyle" Width="180px" />
                                                            <HeaderStyle CssClass="headerStyle" />
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Confirm Status">
                                                            <ItemStyle CssClass="itemstyle" />
                                                            <HeaderStyle CssClass="headerStyle" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblpStatus1" runat="server" Text=""></asp:Label>
                                                                <asp:Label ID="lblappId" runat="server" Text='<%# Bind("AppointmentID")%>' Visible="false"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Payment">
                                                            ...
                                                            <HeaderStyle CssClass="headerStyle" />
                                                            <ItemTemplate>
                                                                <asp:HyperLink ID="HypName" runat="server" NavigateUrl='<%# "PrePaymentInfo.aspx?AppID=" + Eval("AppointmentID") %>'
                                                                    Text="Make Payment"></asp:HyperLink>
                                                                <asp:Label ID="lblPaidStatus" runat="server" Text="Paid" Visible="false"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Delete">
                                                            <ItemStyle CssClass="itemstyle" Width="5%" HorizontalAlign="center" Wrap="false" />
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="btnDeleteApp" runat="server" ImageUrl="images/deleteicon.gif"
                                                                    ...
                                                                    CommandArgument='<%# Bind("AppointmentID") %>' />
                                                            </ItemTemplate>
                                    ...
                                    <table width="100%" border="0">
                                        <tr>
                                            <td colspan="2">
                                                <br />
                                                <br />
                                                <asp:Label ID="Label1" runat="server" Text="Appointment History" Font-Bold="true"
                                                    Font-Size="Medium" ForeColor="#009ddc"> </asp:Label>
                                            </td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" DataKeyNames="AppointmentID" AutoGenerateColumns="False"
                                                    AllowSorting="false" AllowPaging="true" OnPageIndexChanging="GridView1_PageIndexChanging"
                                                    OnRowDataBound="GridView1_RowDataBound" OnDataBound="GridView1_DataBound" PageSize="10"
                                                    CellPadding="0" GridLines="Vertical" Width="100%" HeaderStyle-CssClass="headerStyle"
                                                    CssClass="viewgridStyle" AlternatingRowStyle-CssClass="altGridStyle" OnRowCreated="GridView1_RowCreated">
                                                    <PagerTemplate>
                                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Page" CommandArgument="First">First</asp:LinkButton>
                                                        <asp:Label ID="pmore" runat="server" Text="..."></asp:Label>
                                                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Page" CommandArgument="Prev">Prev</asp:LinkButton>
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Date">
                                                            ...
                                                            <HeaderStyle CssClass="headerStyle" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblAppointmentDate" runat="server" Text='<%# Eval("AppointmentDate","{0:MM/dd/yyyy}")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Cost">
                                                            ...
                                                            <HeaderStyle CssClass="headerStyle" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblStatus" runat="server" Text='<%# Bind("ExpectedTotalRevenue")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntFooter" runat="server">
    ...
    <script type="text/javascript" lang="javascript" src="Scripts/Validation.js"
        defer="defer"></script>
