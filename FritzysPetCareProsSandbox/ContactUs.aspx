<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="FritzysPetCareProsSandbox.ContactUs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   ...
   <script type="text/javascript">
       $(document).ready(function () {
           ...
           $("div#topnav > ul#nav1 > li > a#contactus").addClass("active");
            ...
            <div id="wrapper">
                ...
                <div id="mainInnerContent">
                    ...
                    <div id="innerLeftPannel">
                        ...
                        <div class="title">
                            <asp:Image ID="contactustitle" ImageUrl="http://localhost:50372/Images/contactTitle.jpg" runat="server" AlternateText="" />
                        </div>
                        <div class="leftInner">
                            <div id="contactmain">
                                <div id="contactLeftPannel" style="border: 0px solid; margin: 200px 0 0 0;">
                                    <asp:Image ID="contactleftimg" ImageUrl="http://localhost:50372/Images/contactLeftDogImg.jpg" runat="server" AlternateText="" />
                                </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <p>
                                                            ...
                                                            15540 Rockfield Blvd., STE D, Irvine, CA, 92618.
                                                            <br />

                                                            Email: <a href="mailto:customerservice@fritzyspetcarepros.com">customerservice@fritzyspetcarepros.com</a>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:Image ID="contactshadow" ImageUrl="http://localhost:50372/Images/contactBgshadow.jpg" runat="server" AlternateText="" /></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <table cellspacing="5">
                                                            <tr>
                                                                <td style="width: 106;">
                                                                    <label>
                                                                        First Name<span class="star">*</span></label></td>
                                                                <td>
                                                                    <asp:TextBox ID="txtFName" runat="server" CssClass="contacttextField" MaxLength="20"
                                                                        ValidationGroup="valContactus"></asp:TextBox></td>
                                                                ...
                                                                <asp:CustomValidator runat="server" ID="custSpChar" ValidationGroup="valContactus"
                                                                    ControlToValidate="txtFName" Display="None" SetFocusOnError="true"
                                                                    ClientValidationFunction="ValidateChar123"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <label>
                                                                        Last Name</label></td>
                                                                <td>
                                                                    <asp:TextBox ID="txtLName" runat="server" CssClass="contacttextField" MaxLength="20" ValidationGroup="valContactus"></asp:TextBox>
                                                                    <asp:CustomValidator runat="server" ID="CustomValidator2" ValidationGroup="valContactus"
                                                                        ControlToValidate="txtLName" Display="None" SetFocusOnError="true"
                                                                        ClientValidationFunction="ValidateChar123"
                                                                        ErrorMessage="<b> Special characters not allowed</b> ."></asp:CustomValidator>
                                                                    <ajaxtoolkit:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender2" TargetControlID="CustomValidator2"
                                                                        HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <label>
                                                                        Email<span class="star">*</span></label></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtMobile" runat="server" CssClass="contacttextField" onkeydown="javascript:backspacerDOWN(this,event);"
                                                                        onkeyup="javascript:backspacerUP(this,event);"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="height: 24px">
                                                                    <label>
                                                                        Message<span class="star">*</span></label></td>
                                                                <td style="height: 24px">
                                                                    <asp:TextBox Height="60px" Rows="5" Columns="20" TextMode="MultiLine" ID="txtMessage" runat="server" CssClass="contacttextField" MaxLength="300"
                                                                        ValidationGroup="valContactus" onkeyDown="checkTextAreaMaxLength(this,event,'200');"></asp:TextBox></td>
                                                                ...
                                                                <asp:CustomValidator runat="server" ID="CustomValidator1" ValidationGroup="valContactus"
                                                                    ControlToValidate="txtMessage" Display="None" SetFocusOnError="true"
                                                                    ClientValidationFunction="ValidateChar123"
                                                                    ErrorMessage="<b> Special characters not allowed</b> ."></asp:CustomValidator>
                                                                <ajaxtoolkit:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender1" TargetControlID="CustomValidator1"
                                                                    HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                                            </tr>
                                                            <tr>
                                                                <td>&nbsp;</td>
                                                                <td>
                                                                    <asp:ImageButton ID="btnSave" runat="server" ImageUrl="http://localhost:50372/Images/contactSendButton.jpg"
                                                                        ValidationGroup="valContactus" OnClick="btnSave_Click" /></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Note: Fields marked with <span class="star">*</span> required</td>
                                                </tr>
                                            </table>
                                            <%--***************Form ends here************************--%>
                                        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntFooter" runat="server">
    ...
    <script type="text/javascript" lang="javascript" src="../Scripts/phone_validation.js" defer="defer"></script>
