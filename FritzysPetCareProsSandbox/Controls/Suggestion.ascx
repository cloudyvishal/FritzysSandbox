<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Suggestion.ascx.cs" Inherits="FritzysPetCarePros.Controls.Suggestion" %>
...
<script type="text/javascript" lang="javascript">
    ...
    function CleareText() {
        ...
        document.getElementById("ctl00_cntBody_ctlSuggestion_txtName").value = "*Name";
    ...
    function SetName() {
        if (document.getElementById("ctl00_cntBody_ctlSuggestion_txtName").value == "*Name") {
            document.getElementById("ctl00_cntBody_ctlSuggestion_txtName").value = "";
        }
    }
    function SetEmail() {
...
<cc1:ModalPopupExtender ID="ModalPopupExtender5" runat="server" TargetControlID="btnSuggestion"
...
<asp:Panel Style="display: none" ID="PanelFiveImg" runat="server">
    <div style="border: 2px solid #6d5c45;">
        <div id="suggestionpopup">
            <div class="popupleft">
                <asp:Image ID="popupimg" ImageUrl="http://localhost:50372/Images/popupImg.jpg" runat="server" AlternateText=" " />
            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="closewindow">
                                                    <asp:ImageButton ID="closewindow" ImageUrl="http://localhost:50372/Images/closeImg.jpg" runat="server" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Image ID="suggestionboxheader" ImageUrl="http://localhost:50372/Images/suggestionBoxHeader.jpg" runat="server" AlternateText=" " /></td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtName" CssClass="textField" runat="server" Text="" MaxLength="30"
                                                        ValidationGroup="valSuggest1" OnFocus="SetName();" OnClick="SetName();"></asp:TextBox>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" SetFocusOnError="true"
                                                        ControlToValidate="txtName" Display="None" ValidationGroup="valSuggest1" ErrorMessage="<b>Required Field Missing</b><br />Name is required.">  
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtEmail" runat="server" CssClass="textField" MaxLength="30" ValidationGroup="valSuggest1"
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtEmail"
                                                        Display="None" ValidationGroup="valSuggest1" ErrorMessage="<b>Required Field Missing</b><br />Email is required."
                                                    ...
                                                    <asp:RegularExpressionValidator ID="revEmail" runat="server" Display="None" ErrorMessage="<b>Required Field Missing</b><br />Please enter correct email."
                                                        ValidationGroup="valSuggest1" SetFocusOnError="true" ControlToValidate="txtEmail"
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:TextBox Rows="5" Columns="20" CssClass="textArea" ValidationGroup="valSuggest1"
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" SetFocusOnError="true"
                                                        ControlToValidate="txtComment" Display="None" ValidationGroup="valSuggest1" ErrorMessage="<b>Required Field Missing</b><br />Comment is required.">  
                                                    </asp:RequiredFieldValidator>
                                                    <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender3"
                                                        TargetControlID="RequiredFieldValidator2" HighlightCssClass="validatorCalloutHighlight"
                                                        Enabled="true" />
                                                    <asp:CustomValidator runat="server" ID="CustomValidator1" ValidationGroup="valSuggest1"
