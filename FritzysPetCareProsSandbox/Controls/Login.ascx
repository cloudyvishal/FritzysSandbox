...
<script type="text/javascript" lang="javascript">
    function showForgot() {
        ...
        document.getElementById('<%="ctl00_ctl06_divForgot" %>').style.display = "block";
        document.getElementById('<%="ctl00_ctl06_DivlnkForgot" %>').style.display = "none";
        return false;
    }
    function HideForgot() {
                            ...
                            <td>
                                ...
                                <div id="divForgot" runat="server" style="display: none; border: 1px solid #baa080; margin: 0 0 10px 0;">
                                    <table border="0" width="100%">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:ImageButton ID="ImgSubmitForgot" runat="server" ImageUrl="http://localhost:50372/Images/submitbutton.jpg"
