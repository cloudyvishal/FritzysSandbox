...
<div class="locationServiced" onkeypress="javascript:return FormPanel_FireDefaultButtonZip(event,'ctl00_ContentPlaceHolder1_ctlZipcode_imgZipcode')">
    ...
    <div>
        <asp:ImageButton ID="imgZipcode" runat="server" CssClass="gobtn" ImageUrl="http://localhost:50372/Images/btn_go.gif" ValidationGroup="valZip" AlternateText="Go" ToolTip="Go" OnClick="imgZipcode_Click" />
    </div>
...
<asp:Panel Style="display: none" ID="PanelFiveImg" runat="server" CssClass="zipPopupDiv">
    <table class="zipmodalPopup" border="0">
        <tbody>
            <tr>
                <td align="right">
                    <asp:ImageButton ID="imgClose" runat="server" ImageUrl="http://localhost:50372/Images/closeImgButton.jpg" />
                </td>
            </tr>
            <tr>
