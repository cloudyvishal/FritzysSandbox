...
<div id="NormalAppointment" runat="server" class="img">
    <asp:ImageButton ID="ImgAppointment" runat="server" ImageUrl="http://localhost:50372/Images/make_appointment_now.jpg" OnClick="ImgAppointment_Click" ToolTip="MAKE AN APPOINTMENT NOW" />
</div>
