...
<div class="leftInner">
    <div class="ServicesinnerPannelLeft">
        <div class="innerTitle">
            <img src="http://localhost:50372/Images/for_your_dogs_title.jpg" alt="Dog Grooming, Cat Grooming" />
        </div>
                        ...
                        <ItemTemplate>
                            <div class="news">
                                <div class="servicesImages">
                                    <asp:Image ID="Image1" ImageUrl="http://localhost:50372/Images/dogPaw.jpg" runat="server" AlternateText=" " />
                                </div>
    ...
    <div class="ServicesinnerMidPannel">
        <asp:Image ID="imgDivider" ImageUrl="http://localhost:50372/Images/midDivider.jpg" runat="server" AlternateText=" " />
    </div>
