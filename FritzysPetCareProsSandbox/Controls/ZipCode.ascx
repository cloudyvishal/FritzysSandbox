    ...
    <ContentTemplate>
        ...
        <div class="locationServiced">
            ...
            <div style="z-index: 10; position: absolute;">
                <asp:ImageButton ID="imgZipcode" runat="server" ImageUrl="http://localhost:50372/Images/btn_go.gif" AlternateText="Go"
            ...
            <div id="jquery-lightbox">
                <div id="lightbox-container-image-box">
                    <div id="lightbox-container-image">
                        ...
                        <img src="http://localhost:50372/Images/lightbox-ico-loading.gif" alt="">
                    </div>
                </div>
            </div>
        </div>
