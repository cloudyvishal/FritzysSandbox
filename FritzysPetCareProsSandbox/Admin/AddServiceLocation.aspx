<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddServiceLocation.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.AddServiceLocation" %>
    ...
    <div class="innerContent">
        ...
        <table class="adduserTable" cellpadding="6" cellspacing="0">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtZipCode" CssClass="textBox" runat="server" MaxLength="5"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtZipCode"
                        Display="None" SetFocusOnError="true" ErrorMessage="<b>Required Field Missing</b><br />Zipcode name is required.">  
                    ...
                    <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender49"
                        TargetControlID="RegValZip" HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtCity" CssClass="textBox" runat="server" MaxLength="45"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCity"
                        Display="None" SetFocusOnError="true" ErrorMessage="<b>Required Field Missing</b><br />City is required.">  
                    </asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtState" CssClass="textBox" runat="server" MaxLength="45"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtState"
                        Display="None" SetFocusOnError="true" ErrorMessage="<b>Required Field Missing</b><br />State is required.">  
                    </asp:RequiredFieldValidator>
            ...
            <tr style="display: none;">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="<b>Required Field Missing</b><br />Status is required"
        ...
        <asp:Button ID="AddUser" runat="server" Text="Add ZipCode" ToolTip="Add ZipCode"
            CssClass="btnBg" OnClick="AddUser_Click" />
        <asp:Button ID="btnBack" runat="server" Text="Cancel" ToolTip="Cancel" CssClass="btnBg"
            CausesValidation="false" PostBackUrl="~/Admin/LocationService/ManageLocations.aspx?SearchFor=0&SearchText=" />
    </div>
</asp:Content>
