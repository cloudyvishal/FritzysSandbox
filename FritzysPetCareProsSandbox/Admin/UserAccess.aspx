<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="UserAccess.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.UserAccess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        ...
        <asp:GridView ID="grdAccess" runat="server" AutoGenerateColumns="False" CellPadding="0"
            AllowSorting="true" AllowPaging="True" DataKeyNames="AccessID" GridLines="Vertical" OnPageIndexChanging="grdAccess_PageIndexChanging"
        ...
        <div id="divAddBreed" runat="server" style="display: block" class="itemstyle">
            User Type :
            <asp:DropDownList ID="ddlUserType" runat="server" CssClass="regddlField">
                <asp:ListItem Value="User Type">Select User Type</asp:ListItem>
                <asp:ListItem Value="0">Admin</asp:ListItem>
                <asp:ListItem Value="1">SubAdmin</asp:ListItem>

            </asp:DropDownList>
            <asp:CompareValidator runat="server" ID="ClassMustBeSelected" ControlToValidate="ddlUserType" ValueToCompare="User Type" Operator="NotEqual" Type="String" ErrorMessage="Please select user type">
