<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="VisitVan.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.VisitVan" ValidateRequest="false" %>
    ...
    <div class="innerContent">
        ...
        <table class="adduserTable" cellpadding="6" cellspacing="0">
            ...
            <asp:FileUpload ID="fuFile" runat="server" />
                    ...
                    <asp:Button ID="btnUp" runat="server" Text="Upload" ToolTip="Upload" CssClass="servbtnBg" OnClick="btnUp_Click" /><br />
                    <br />
