<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageFriends.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ManageFriends" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        <div class="pageTitle">
            <h2>Manage Fritzy's Friends Content</h2>
        </div>
        ...
        <asp:GridView ID="GrdFriends" runat="server" DataKeyNames="FriendID" AutoGenerateColumns="False"
            AllowSorting="true" AllowPaging="true" PageSize="10" OnPageIndexChanging="GrdFriends_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:HyperLinkField ItemStyle-CssClass="itemstyle" HeaderStyle-CssClass="headerStyle" DataNavigateUrlFields="FriendID" DataNavigateUrlFormatString="EditFriends.aspx?FriendID={0}"
                    DataTextField="Title" HeaderText="Friends Title" SortExpression="Title"></asp:HyperLinkField>
        ...
        <asp:Button ID="btnAdd" runat="server" Text="Add Friend" ToolTip="Add Friend" CssClass="btnBg" PostBackUrl="~/Admin/AddFriends.aspx" />&nbsp;&nbsp;&nbsp;
