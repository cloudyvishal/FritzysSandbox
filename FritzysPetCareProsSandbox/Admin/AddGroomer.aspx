<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddGroomer.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.AddGroomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        ...
        <table class="adduserTable" cellpadding="6" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:CompareValidator ID="cmp1" runat="server" ErrorMessage="Please Confirm Password"
        ...
        <asp:Button ID="btnCancel" runat="server" CausesValidation="false" Text="Cancel"
            PostBackUrl="~/Admin/ManageGroomer.aspx?SearchFor=0&SearchText=" ToolTip="Cancel"
            CssClass="btnBg" />
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphFooter" runat="server">
    ...
    <script type="text/javascript" lang="javascript" src="../Scripts/Validation.js"></script>
