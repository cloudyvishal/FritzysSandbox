...
{
    public partial class ManageReferalSource : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    CheckAll();
                    check();
                    CommonFunctions.Setserial(gdvReferalSource, "srno");
        ...
        protected void btnStatus_Click(object sender, EventArgs e)
        {
            try
            {
                string StrReferalID = CommonFunctions.GetCheckedRow(gdvReferalSource, "chkSelect");
                if (StrReferalID != "")
                {
                    StoreFront ObjStoreFront = new StoreFront();
