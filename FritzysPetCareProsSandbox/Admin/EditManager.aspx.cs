...
{
    public partial class EditManager : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    Response.Redirect("ManageManager.aspx");
                }
            }
        }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int Count = ObjUser.UpdateAdminUser(int.Parse(Request.QueryString["UserID"]), txtFirstName.Text.Trim(), txtLastName.Text.Trim(), txtUserName.Text.Trim(), txtPassword.Text.Trim(), txtEmail.Text.Trim(), txtPhone.Text.Trim(), txtAddress1.Text.Trim(), txtAddress2.Text.Trim(), 1);
