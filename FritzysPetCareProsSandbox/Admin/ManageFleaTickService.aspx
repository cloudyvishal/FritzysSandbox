<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageFleaTickService.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ManageFleaTickService" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        <div class="pageTitle">
            <h2>Manage Flea & Tick Page Services</h2>
        </div>
        ...
        <asp:GridView ID="GrdServiceHome" runat="server" DataKeyNames="ServiceID" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:HyperLinkField ItemStyle-CssClass="itemstyle" HeaderStyle-CssClass="headerStyle"
                    DataNavigateUrlFields="ServiceID" DataNavigateUrlFormatString="EditFleaTickService.aspx?ServiceID={0}"
