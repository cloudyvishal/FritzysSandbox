<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Suggestion.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.Suggestion" %>
            ...
            <table border="0" style="margin: 10px 0pt 0pt;">
                <tr>
                    ...
                    <td>
                        ...
                        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" Format="MM/d/yyyy" PopupButtonID="imgCalPop"
                    ...
                    <td>
                        ...
                        <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" Format="MM/d/yyyy" PopupButtonID="ImageButton1"
