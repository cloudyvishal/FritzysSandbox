<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageGroomer.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ManageGroomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        ...
        <div id="divBtn" runat="server" style="display: block;">
            <asp:Button ID="btnAdd" runat="server" Text="Add" ToolTip="Add Groomers" CssClass="btnBg"
                PostBackUrl="~/Admin/AddGroomer.aspx" />&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnDelete" runat="server" Text="Delete" ToolTip="Delete" CssClass="btnBg"
                OnClick="btnDelete_Click" />&nbsp;&nbsp;&nbsp;
            <asp:Button ID="lnkNorec" runat="server" CssClass="gobackbtnBg" Text="Go Back" Visible="false"
