...
{
    public partial class AppointmentDateSetting : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("AppointmentDateSetting.aspx", false);
            } finally{}
        ...
        private void BindGrid()
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    CommonFunctions.Setserial(gdvBreed, "srno");
                }
                else
                {
        ...
        protected void btnStatus_Click(object sender, EventArgs e)
        {
            try
            {
                string AdId = CommonFunctions.GetCheckedRow(gdvBreed, "chkSelect");
