    ...
    public partial class ManageServices : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        CommonFunctions.Setserial(gdvStaticFiles, "srno");
        ...
        public void BindData()
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                CommonFunctions.Setserial(GrdService, "srno");
            }
            else
            {
                GrdService.Visible = true;
        ...
        protected void GrdService_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label lblServiceID1 = (Label)e.Row.FindControl("lblServiceID1");

                int SID = Convert.ToInt32(lblServiceID1.Text);

                string Temp = Convert.ToString(ConfigurationManager.AppSettings["HomePathValue"]);
                ...
                {
                    imgThumb.Src = ConfigurationManager.AppSettings["HomePathValue"] + "StoreData/ServicePageServices/" + lblImageName.Text;
                }
                else
                {
                }
            ...
            try
            {
                ...
                for (int i = 0; i <= gdvStaticFiles.Rows.Count - 1; i++)
                {
                    ...
                    if (chk.Checked)
                    {
                        ...
                        string LogicalPath = ConfigurationManager.AppSettings["HomePathValue"] + "StoreData/Images/" + lblImageName.Text;
                        ...
                        LogicalPath = ConfigurationManager.AppSettings["HomePathValue"] + "StoreData/" + lblFileName.Text;
        ...
        public void DeletePosition(int Position, int ServiceID)
        {
            try
            {
                ...
                ObjService.DeleteService(ServiceID.ToString());
                ...
                {
                    ObjService.SetPositionDown(i, Convert.ToInt32(ddlPet.SelectedValue));
                }
        ...
        {
            string ServiceID = CommonFunctions.GetCheckedRow(gdvStaticFiles, "chkSelect");

            if (ServiceID != "")
            {
                Services ObjService = new Services();

                ObjService.UpdateStatus(ServiceID);
            }
            BindGrid(Convert.ToInt32(ddlPet.SelectedValue));
        }
        ...
        protected void btnSetHome_Click(object sender, EventArgs e)
        {
            ...
            if (str.Length <= 1)
            {
                ...
                ObjService.SetIsHome(ServiceID, Convert.ToInt32(ddlPet.SelectedValue));
            }
            else
            {
        ...
        protected void btnSetFlea_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (str.Length <= 1)
                {
                    ...
                    ObjService.SetIsFlea(ServiceID, Convert.ToInt32(ddlPet.SelectedValue));
                }
                else
                {
                    ErrMessage("You can not set more than two services.");
        ...
        protected void ddlList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        ObjService.SetPositionUp(j, Convert.ToInt32(ddlPet.SelectedValue));
                    }
                }

                Services ObjServiceN = new Services();

                ObjServiceN.SetNewPosition(ServiceID, NewIndex);
        ...
        {
            string url = ConfigurationManager.AppSettings["HomePathValue"] + "Services.aspx";
