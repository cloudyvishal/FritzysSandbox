...
{
    public partial class AppointmentSettings : System.Web.UI.Page
    {
        ...
        protected void gdvBreed_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                lnkEdit.NavigateUrl = string.Concat("EditAppointmentSetting.aspx?dt=", Convert.ToString(lblDate.Text));
