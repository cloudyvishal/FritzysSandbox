...
{
    public partial class ManageAgents : BasePage
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public void Bind()
        {
            ...
            try
            {
                ...
                ds = ObjUser.GetAllAgent(Request.QueryString["SearchFor"].ToString(), Request.QueryString["SearchText"].ToString());
        ...
        {
            Response.Redirect("ManageAgents.aspx?SearchFor=0&SearchText=");
        }
        ...
        {
            Response.Redirect("ManageAgents.aspx?SearchFor=" + ddlSearch.SelectedValue + "&SearchText=" + txtSearch.Text.Trim());
        }
