...
{
    public partial class EditAdminUser : System.Web.UI.Page
    {
        ...
        public void Bind(int UserID)
        {
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    ddlType.SelectedValue = ds.Tables[0].Rows[0]["UserType"].ToString();
                }
                else
                {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int Count = ObjUser.UpdateAdminUser(int.Parse(Request.QueryString["UserID"]), txtFirstName.Text.Trim(), txtLastName.Text.Trim(), txtUserName.Text.Trim(), txtPassword.Text.Trim(), txtEmail.Text.Trim(), txtPhone.Text.Trim(), txtAddress1.Text.Trim(), txtAddress2.Text.Trim(), Convert.ToInt32(ddlType.SelectedValue));
