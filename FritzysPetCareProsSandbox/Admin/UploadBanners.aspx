...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        ...
        <table class="adduserTable" cellpadding="6" cellspacing="0">
            <tr>
                <td style="width: 13%;" valign="top">Select Banner :
                </td>
                <td>
        ...
        <div>
            <asp:GridView ID="GrdBaner" runat="server" AutoGenerateColumns="False" AllowSorting="true"
                AllowPaging="true" PageSize="15" CellPadding="0" GridLines="Vertical" Width="100%"
                        ...
                        <ItemTemplate>
                            <div style="padding: 5px 0px; width: 180px; border: 0px solid #f00;">
                                <img alt="Image" width="170" height="80" src='<%#DataBinder.Eval(Container.DataItem,"virtualmobilepath") %>'
                                    runat="server" id="imgThumbMobile" />
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Used In">
                        ...
                        <ItemTemplate>
                            <div style="width: 400px; word-wrap: break-word;">
                                <asp:Label ID="lblUserForms" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"UsedForms") %>'></asp:Label>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <br />
        <asp:Label ID="Label1" runat="server" Text="1=Unregistered User, 2=Registered User-Cat, 3=Registered User-Dog, 4=Registered User-Cat & Dog."
