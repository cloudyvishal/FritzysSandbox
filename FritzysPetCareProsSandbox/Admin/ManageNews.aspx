<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageNews.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ManageNews" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
       ...
       <br />
        ...
        <asp:Button ID="btnAdd" runat="server" CssClass="btnBg" Text="Add News" ToolTip="Add News" PostBackUrl="~/Admin/AddNews.aspx" />
