...
namespace FritzysPetCareProsSandbox.Admin
{
    public partial class ManageFriends : System.Web.UI.Page
    {
        ...
        public void Bind()
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    CommonFunctions.Setserial(GrdFriends, "srno");
        ...
        protected void btnStatus_Click(object sender, EventArgs e)
        {
            try
            {
                string FriendID = CommonFunctions.GetCheckedRow(GrdFriends, "chkSelect");
        ...
        protected void SaveFile(string StrContent)
        {
            try
            {
                string Fullpath = ConfigurationManager.AppSettings["HomePathValue"] + "StoreData/StaticeContent/" + "Friend.htm";
