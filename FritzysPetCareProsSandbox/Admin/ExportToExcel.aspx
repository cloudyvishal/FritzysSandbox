<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ExportToExcel.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ExportToExcel" %>
                ...
                <table class="setservPage2" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <asp:GridView ID="GrdUsers" runat="server" DataKeyNames="DailyLogID" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:HyperLinkField ItemStyle-CssClass="itemstyle" HeaderStyle-CssClass="headerStyle1"
                                            ...
                                            Text="Details" HeaderText="Details"></asp:HyperLinkField>
                                    </Columns>
                                </asp:GridView>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <asp:Button ID="btnExport" runat="server" CssClass="gobackbtnBg" Text="Export To Excel" ValidationGroup="valContactus" OnClick="btnExport_Click" Visible="false" /></td>
                    </tr>
                </table>
            </div>
            <tr>
