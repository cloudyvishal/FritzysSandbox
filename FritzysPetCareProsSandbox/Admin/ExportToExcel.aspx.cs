...
namespace FritzysPetCareProsSandbox.Admin
{
    public partial class ExportToExcel : System.Web.UI.Page
    {
        ...
        {
            strDailyLogID = CommonFunctions.GetCheckedRow(GrdUsers, "chkSelect");
        ...
        public void getDailyOperationLog(int m, string GID, string DailyLogID, DataSet ds)
        {
            ...
            try
            {
                ...
                if (dsEx.Tables[0].Rows.Count > 0)
                {
                    ...
                    FuelPurchased_Data = dsEx.Tables[0].Rows[m]["FuelPurchased"].ToString();

                    PricePerGallon_Data = dsEx.Tables[0].Rows[m]["PricePerGallon"].ToString();
                    ...
                    CreditCardNo_Data = dsEx.Tables[0].Rows[m]["CreditCardNo"].ToString();
