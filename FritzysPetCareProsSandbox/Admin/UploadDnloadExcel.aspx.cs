...
{
    public partial class UploadDnloadExcel : System.Web.UI.Page
    {
        ...
        double RevenueCreditCard, RevenueCheck, RevenueCash, RevenueInvoice, TipCreditCard, TipCheck, TipCash, TipInvoice, PriorCreditCard, PriorCheck, PriorCash;
        string strGId, CustomerName, Job, ZipCode, Pets, Rebook, FromRebook, New, TimeIn, TimeOut, PetTime, ExtraServices, comments, CreditCardNo, CreditCardExpir, CreditCardORChkName, CreditCardORChkAddr, SecurityCode, NextAppomentDate, NextAppomentTime, NextAppointmentEndTime, ServicesForPet1, ServicesForPet2, ServicesForPet3, ServicesForPet4, ServicesForPet5, ServicesForPet6;
        int AppointmentID, rDriveTimeData, rPetTimeData;
        string revValidate = "";
        ...
        Excel.Worksheet excelSheetEnd = null;
        #endregion
        ...
        int data_rowGift = 0, secRowGift = 0;
        ...
        protected void InitializeExcel2()
        {
            try
            {
                ...
                excelSheetInv = new Microsoft.Office.Interop.Excel.Worksheet();
            }
            catch (System.Runtime.InteropServices.COMException ex)
            {
            }
        ...
        protected void InitializeExcel3()
        {
            try
            {
                ...
                excelSheetEnd = new Microsoft.Office.Interop.Excel.Worksheet();
            }
            catch (System.Runtime.InteropServices.COMException ex)
            {
            }
        ...
        protected void InitializeExcel4()
        {
            try
            {
                ...
                excelSheetGift = new Microsoft.Office.Interop.Excel.Worksheet();
            }
            catch (System.Runtime.InteropServices.COMException ex)
            {
            }
        ...
        public void ExportToExcelNew()
        {
            try
            {
                ...
                if (dsNoExp.Tables[0].Rows.Count > 0)
                {
                    ...
                    Excel.Workbook excelWorkBook = excelApp.Workbooks.Open(ExistsExcelFilePath1, 0, false, 5, password, password, true, Microsoft.Office.Interop.Excel.XlPlatform.xlWindows, "\t", true, false, 0, true, 1, 0);
                ...
                NextRow:
                    for (int rowcount = data_row; rowcount < dsNoExp.Tables[0].Rows.Count; rowcount++)
                    {
                        ...
                        for (int sheetNum = 1; sheetNum < numSheets; sheetNum++)
                        {
                            ...
                            {
                                excelSheet = (Excel.Worksheet)excelSheets.get_Item(dsNoExp.Tables[0].Rows[rowcount]["sheetName"].ToString());
                                            ...
                                            if (strdate == strSelDate)
                                            {
                                                ...
                                                for (int k = secRow; k < (secRow + 10); k++)
                                                {
                                                    ...
                                                    if (range != null)
                                                    {
                                                        ...
                                                        {
                                                            #region fileds
                                                            excelSheet.get_Range(Job1 + k, Job1 + k).Value2 = Job_Data;
                                                            excelSheet.get_Range(CustomerName1 + k, CustomerName1 + k).Value2 = CustomerName_Data;
                                                            excelSheet.get_Range(ZipCode1 + k, ZipCode1 + k).Value2 = ZipCode_Data;
                                                            excelSheet.get_Range(Pets1 + k, Pets1 + k).Value2 = Pets_Data;
                                                            excelSheet.get_Range(Rebook1 + k, Rebook1 + k).Value2 = Rebook_Data;
                                                            ...
                                                            excelSheet.get_Range(FromRebook1 + k, FromRebook1 + k).Value2 = FromRebook_Data;
                                                            ...
                                                            excelSheet.get_Range(FleaandTick221 + k, FleaandTick221 + k).Value2 = FleaandTick22_Data;
                                                            excelSheet.get_Range(FleaandTick441 + k, FleaandTick441 + k).Value2 = FleaandTick44_Data;
                                                            excelSheet.get_Range(FleaandTick881 + k, FleaandTick881 + k).Value2 = FleaandTick88_Data;
                                                            excelSheet.get_Range(FleaandTick1321 + k, FleaandTick1321 + k).Value2 = FleaandTick132_Data;
                                                            excelSheet.get_Range(FleaandTickCat1 + k, FleaandTickCat1 + k).Value2 = FleaandTickCat_Data;
                                                            excelSheet.get_Range(TB1 + k, TB1 + k).Value2 = TB_Data;
                                                            excelSheet.get_Range(Wham1 + k, Wham1 + k).Value2 = Wham_Data;

                                                            #endregion
                                                            #region revenue 7 cells
                                                            excelSheet.get_Range(RevenueCreditCard1 + k, RevenueCreditCard1 + k).Value2 = RevenueCreditCard_Data;
                                                            excelSheet.get_Range(RevenueCheck1 + k, RevenueCheck1 + k).Value2 = RevenueCheck_Data;
                                                            excelSheet.get_Range(RevenueCash1 + k, RevenueCash1 + k).Value2 = RevenueCash_Data;
                                                            excelSheet.get_Range(RevenueInvoice1 + k, RevenueInvoice1 + k).Value2 = RevenueInvoice_Data;
                                                            if (RevCCY_Data != "")
                                                            {
                                                                excelSheet.get_Range(RevenueCreditCard1 + k, RevenueCreditCard1 + k).Value2 = RevCCY_Data;
                                                            }
                                                            excelSheet.get_Range(ProductPrice1 + k, ProductPrice1 + k).Value2 = ProductPrice_Data;
                                                            excelSheet.get_Range(SalesTax1 + k, SalesTax1 + k).Value2 = SalesTax_Data;
                                                            #endregion
                                                            #region Tip 4 cells
                                                            excelSheet.get_Range(TipCreditCard1 + k, TipCreditCard1 + k).Value2 = TipCreditCard_Data;
                                                            excelSheet.get_Range(TipCheck1 + k, TipCheck1 + k).Value2 = TipCheck_Data;
                                                            excelSheet.get_Range(TipCash1 + k, TipCash1 + k).Value2 = TipCash_Data;
                                                            excelSheet.get_Range(TipInvoice1 + k, TipInvoice1 + k).Value2 = TipInvoice_Data;
                                                            #endregion
                                                            #region Prior Revenue 8 cells
                                                            excelSheet.get_Range(PriorCreditCard1 + k, PriorCreditCard1 + k).Value2 = PriorCreditCard_Data;
                                                            excelSheet.get_Range(PriorCheck1 + k, PriorCheck1 + k).Value2 = PriorCheck_Data;
                                                            excelSheet.get_Range(PriorCash1 + k, PriorCash1 + k).Value2 = PriorCash_Data;

                                                            excelSheet.get_Range(CreditCardNo1 + k, CreditCardNo1 + k).Value2 = CreditCardNo_Data;
                                                            excelSheet.get_Range(CreditCardExpir1 + k, CreditCardExpir1 + k).Value2 = CreditCardNo_Data;
                                                            excelSheet.get_Range(CreditCardName + k, CreditCardName + k).Value2 = CreditCardNo_Data;
                                                            excelSheet.get_Range(CreditCardAddr + k, CreditCardAddr + k).Value2 = CreditCardNo_Data;
                                                            excelSheet.get_Range(SecurityCode1 + k, SecurityCode1 + k).Value2 = CreditCardNo_Data;

                                                            excelSheet.get_Range(EndingMileage + k, EndingMileage + k).VerticalAlignment = VerticalAlign.Middle;
                                                            excelSheet.get_Range(EndingMileage + k, EndingMileage + k).Value2 = AuthCode;


                                                            if (CreditCardNumber_data == "ccy")
                                                                excelSheet.get_Range(CreditCardNo1 + k, CreditCardNo1 + k).Value2 = CreditCardNumber_data;
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (ds.Tables[0].Rows[0]["status"].ToString() == "Unlock")
                    {
                        ...
                        string[] filePaths = Directory.GetFiles(ExcelFilePath1);
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            ExcelFileName = System.IO.Path.GetFileName(ExcelFilePath1);
            ...
            try
            {
                ...
                NextRow:
                    for (int rowcountInv = data_rowInv; rowcountInv < dsNoExpInv.Tables[0].Rows.Count; rowcountInv++)
                    {
                        ...
                        for (int sheetNum = 1; sheetNum < numSheets; sheetNum++)
                        {
                            excelSheetInv = (Excel.Worksheet)excelSheetsInv.get_Item(sheetNum);
                            string strWorksheetName = excelSheetInv.Name;
                            if (strWorksheetName == dsNoExpInv.Tables[0].Rows[rowcountInv]["sheetName"].ToString())
                            {
                                excelSheetInv = (Excel.Worksheet)excelSheetsInv.get_Item(dsNoExpInv.Tables[0].Rows[rowcountInv]["sheetName"].ToString());
                                if (dsExInv.Tables[0].Rows.Count > 0)
                                {
                                    ...
                                    for (int r = 8; r < 381; r = r + 12)
                                    {
                                        range = excelSheetInv.get_Range("B" + r, "B" + r);
                                        strdate = excelSheetInv.get_Range("B" + r, "B" + r).Text.ToString();
                                        if (strdate == string.Empty)
                                        {
                                            continue;
                                        }
                                        else
                                        {
                                            if (strdate == strSelDate)
                                            {
                                                ...
                                                excelSheetInv.get_Range(FleaTick22 + r, FleaTick22 + r).Value2 = FleaTick22_Data;
                                                excelSheetInv.get_Range(FleaTick44 + r, FleaTick44 + r).Value2 = FleaTick44_Data;
                                                excelSheetInv.get_Range(FleaTick88 + r, FleaTick88 + r).Value2 = FleaTick88_Data;
                                                excelSheetInv.get_Range(FleaTick132 + r, FleaTick132 + r).Value2 = FleaTick132_Data;
                                                excelSheetInv.get_Range(FleaTickcAT + r, FleaTickcAT + r).Value2 = FleaTickcAT_Data;

                                                excelSheetInv.get_Range(Toothbrushes + r, Toothbrushes + r).Value2 = Toothbrushes_Data;
                                                excelSheetInv.get_Range(WhamInv + r, WhamInv + r).Value2 = WhamInv_Data;
                                                excelSheetInv.get_Range(Towels + r, Towels + r).Value2 = Towels_Data;
                                                excelSheetInv.get_Range(Treats + r, Treats + r).Value2 = Treats_Data;
                                                excelSheetInv.get_Range(CottonSwabs + r, CottonSwabs + r).Value2 = CottonSwabs_Data;
                                                excelSheetInv.get_Range(EarWipes + r, EarWipes + r).Value2 = EarWipes_Data;
                                                excelSheetInv.get_Range(VetWrap + r, VetWrap + r).Value2 = VetWrap_Data;
                                                excelSheetInv.get_Range(PaperTowels + r, PaperTowels + r).Value2 = PaperTowels_Data;
                                                excelSheetInv.get_Range(GarbageBags + r, GarbageBags + r).Value2 = GarbageBags_Data;
                                                excelSheetInv.get_Range(Receipts + r, Receipts + r).Value2 = Receipts_Data;
                                                excelSheetInv.get_Range(Envelopes + r, Envelopes + r).Value2 = Envelopes_Data;
                                                excelSheetInv.get_Range(BusinessCards + r, BusinessCards + r).Value2 = BusinessCards_Data;

                                                excelSheetInv.get_Range(Other1 + r, Other1 + r).Value2 = Other1_Data;
                                                excelSheetInv.get_Range(Other2 + r, Other2 + r).Value2 = Other2_Data;
                                                excelSheetInv.get_Range(Other3 + r, Other3 + r).Value2 = Other3_Data;
                                                excelSheetInv.get_Range(Other4 + r, Other4 + r).Value2 = Other4_Data;
                                                excelSheetInv.get_Range(Other5 + r, Other5 + r).Value2 = Other5_Data;

                                                excelSheetInv.get_Range(Marketing1 + r, Marketing1 + r).Value2 = Marketing1_Data;
                                                excelSheetInv.get_Range(Marketing2 + r, Marketing2 + r).Value2 = Marketing2_Data;
                                                excelSheetInv.get_Range(Marketing3 + r, Marketing3 + r).Value2 = Marketing3_Data;
                                                excelSheetInv.get_Range(Marketing4 + r, Marketing4 + r).Value2 = Marketing4_Data;
                                                excelSheetInv.get_Range(Marketing5 + r, Marketing5 + r).Value2 = Marketing5_Data;
                                                excelSheetInv.get_Range(comments1 + r, comments1 + r).Value2 = comments_Data;

                                                excelSheetInv.get_Range(Liquid1 + r, Liquid1 + r).Value2 = Liquid1_Data;
                                                excelSheetInv.get_Range(Liquid2 + r, Liquid2 + r).Value2 = Liquid2_Data;
                                                excelSheetInv.get_Range(Liquid3 + r, Liquid3 + r).Value2 = Liquid3_Data;
                                                excelSheetInv.get_Range(Liquid4 + r, Liquid4 + r).Value2 = Liquid4_Data;
                                                excelSheetInv.get_Range(Liquid5 + r, Liquid5 + r).Value2 = Liquid5_Data;
                                                excelSheetInv.get_Range(Liquid6 + r, Liquid6 + r).Value2 = Liquid6_Data;
                                                excelSheetInv.get_Range(Liquid7 + r, Liquid7 + r).Value2 = Liquid7_Data;
                                                excelSheetInv.get_Range(Liquid8 + r, Liquid8 + r).Value2 = Liquid8_Data;
                                                excelSheetInv.get_Range(Liquid9 + r, Liquid9 + r).Value2 = Liquid9_Data;
                                                excelSheetInv.get_Range(Liquid10 + r, Liquid10 + r).Value2 = Liquid10_Data;
                                                excelSheetInv.get_Range(Liquid11 + r, Liquid11 + r).Value2 = Liquid11_Data;
                                                excelSheetInv.get_Range(Liquid12 + r, Liquid12 + r).Value2 = Liquid12_Data;
                                                excelSheetInv.get_Range(Liquid13 + r, Liquid13 + r).Value2 = Liquid13_Data;
                                                excelSheetInv.get_Range(Liquid14 + r, Liquid14 + r).Value2 = Liquid14_Data;
                                                excelSheetInv.get_Range(Liquid15 + r, Liquid15 + r).Value2 = Liquid15_Data;
                                                excelSheetInv.get_Range(Liquid16 + r, Liquid16 + r).Value2 = Liquid16_Data;
                                                excelSheetInv.get_Range(Liquid17 + r, Liquid17 + r).Value2 = Liquid17_Data;
                                                excelSheetInv.get_Range(Liquid18 + r, Liquid18 + r).Value2 = Liquid18_Data;
                                                excelSheetInv.get_Range(Liquid19 + r, Liquid19 + r).Value2 = Liquid19_Data;
                                                excelSheetInv.get_Range(Liquid20 + r, Liquid20 + r).Value2 = Liquid20_Data;
                                                excelSheetInv.get_Range(Liquid21 + r, Liquid21 + r).Value2 = Liquid21_Data;
                                                excelSheetInv.get_Range(Liquid22 + r, Liquid22 + r).Value2 = Liquid22_Data;
                                                excelSheetInv.get_Range(Liquid23 + r, Liquid23 + r).Value2 = Liquid23_Data;
                                                excelSheetInv.get_Range(Liquid24 + r, Liquid24 + r).Value2 = Liquid24_Data;
                                                excelSheetInv.get_Range(Liquid25 + r, Liquid25 + r).Value2 = Liquid25_Data;
            ...
            try
            {
                ...
                NextRow:
                    for (int rowcountEnd = data_rowEnd; rowcountEnd < dsNoExpEnd.Tables[0].Rows.Count; rowcountEnd++)
                    {
                        ...
                        for (int sheetNum = 1; sheetNum < numSheets; sheetNum++)
                        {
                            excelSheetEnd = (Excel.Worksheet)excelSheetsEnd.get_Item(sheetNum);
                            string strWorksheetName = excelSheetEnd.Name;
                            if (strWorksheetName == dsNoExpEnd.Tables[0].Rows[rowcountEnd]["sheetName"].ToString())
                            {
                                excelSheetEnd = (Excel.Worksheet)excelSheetsEnd.get_Item(dsNoExpEnd.Tables[0].Rows[rowcountEnd]["sheetName"].ToString());
                                if (dsExEnd.Tables[0].Rows.Count > 0)
                                {
                                    ...
                                    for (int r = 8; r < 381; r = r + 12)
                                    {
                                        range = excelSheetEnd.get_Range("B" + r, "B" + r);
                                        strdate = excelSheetEnd.get_Range("B" + r, "B" + r).Text.ToString();
                                        if (strdate == string.Empty)
                                        {
                                            continue;
                                        }
                                        else
                                        {
                                            if (strdate == strSelDate)
                                            {
                                                ...
                                                excelSheetEnd.get_Range(TotlaHours + r, TotlaHours + r).Value2 = TotlaHours_Data;
                                                excelSheetEnd.get_Range(EndingMileage + r, EndingMileage + r).Value2 = EndingMileage_Data;
                                                excelSheetEnd.get_Range(FuelPurchased + r, FuelPurchased + r).Value2 = FuelPurchased_Data;
                                                excelSheetEnd.get_Range(PricePerGallon + r, PricePerGallon + r).Value2 = PricePerGallon_Data;
                                                #region update ExcelExported
                ...
                NextRow:
                    for (int rowcount = data_row; rowcount < dsNoExpGift.Tables[0].Rows.Count; rowcount++)
                    {
                        ...
                        for (int sheetNum = 1; sheetNum < numSheets; sheetNum++)
                        {
                            ...
                            {
                                excelSheet = (Excel.Worksheet)excelSheets.get_Item("GiftCards");
