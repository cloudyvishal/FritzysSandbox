<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageManager.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ManageManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        ...
        <asp:GridView ID="GrdUser" runat="server" DataKeyNames="UserID" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:HyperLinkField SortExpression="Username" ItemStyle-CssClass="itemstyle manageuser"
                    HeaderStyle-CssClass="headerStyle" DataNavigateUrlFields="UserID" DataNavigateUrlFormatString="EditManager.aspx?UserId={0}"
        ...
        <asp:Button ID="btnAdd" runat="server" Text="Add Manager" CssClass="btnBg" ToolTip="Add Manager"
            PostBackUrl="~/Admin/AddManager.aspx" />
        ...
        <asp:Button ID="lnkNorec" runat="server" CssClass="servbtnBg" Text="Go Back" Visible="false"
