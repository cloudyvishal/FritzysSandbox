<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditAppointmentSetting.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.EditAppointmentSetting" %>
                ...
                <td>
                    <div id="divsearch" runat="server">
                        <table class="setservPage AppSettingTable" cellpadding="4" cellspacing="0">
                            <tr>
                                <td style="width: 80px;">Select Date:
                                </td>
                                <td>
