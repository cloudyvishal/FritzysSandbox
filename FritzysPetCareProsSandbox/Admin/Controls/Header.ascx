<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="FritzysPetCareProsSandbox.Admin.Controls.Header" %>
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    <tr style="background-color: #997a52;">
        <td id="toplinks">
            <asp:Image ID="IMG1" runat="server" ImageUrl="~/Images/logo.gif" />
        </td>
            ...
            <asp:Menu ID="Menu_admin" Width="400px" Height="20px" runat="server" Orientation="Horizontal"
                ...
                <Items>
                    ...
                    <asp:MenuItem NavigateUrl="~/Admin/Users/ManageUser.aspx" Text="Static Content" Value="static">
                        <asp:MenuItem NavigateUrl="~/Admin/AboutUs.aspx" Text="About Us" Value="About Us">
                        </asp:MenuItem>
                        <asp:MenuItem NavigateUrl="~/Admin/ContactUs.aspx" Text="About Us" Value="About Us">
                        </asp:MenuItem>
                    </asp:MenuItem>
                    <asp:MenuItem NavigateUrl="~/Admin/Users/ManageUser.aspx" Text="Dog" Value="Dog">
                    </asp:MenuItem>
                    ...
                    <asp:MenuItem NavigateUrl="~/Admin/News/ManageNews.aspx" Text="News" Value="News">
                    </asp:MenuItem>
                    <asp:MenuItem Text="VisitVan" Value="VisitVan" NavigateUrl="~/Admin/VisitVan.aspx">
                    </asp:MenuItem>
