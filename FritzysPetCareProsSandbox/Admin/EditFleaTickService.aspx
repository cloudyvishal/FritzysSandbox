<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditFleaTickService.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.EditFleaTickService" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        <div class="pageTitle">
            <h2>Edit Flea and Tick page Service </h2>
        </div>
        ...
        <asp:Button ID="btnCancel" runat="server" CausesValidation="false" Text="Cancel"
            ToolTip="Cancel" CssClass="btnBg" PostBackUrl="~/Admin/ManageFleaTickService.aspx" />
    </div>
</asp:Content>
