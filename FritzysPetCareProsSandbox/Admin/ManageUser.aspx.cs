    ...
    public partial class ManageUser : System.Web.UI.Page
    {
        ...
        public void Bind()
        {
            try
            {
                ...
                ds = ObjUser.GetAllUser(Request.QueryString["SearchFor"].ToString(), Request.QueryString["SearchText"].ToString(), Session["AdminUserType"].ToString());
        ...
        {
            Response.Redirect("ManageUser.aspx?SearchFor=0&SearchText=");
        }

        protected void btnSearch_Click(object sender, EventArgs e)
        {
            Response.Redirect("ManageUser.aspx?SearchFor=" + ddlSearch.SelectedValue + "&SearchText=" + txtSearch.Text.Trim());
        }
