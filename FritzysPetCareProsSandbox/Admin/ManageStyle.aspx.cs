...
{
    public partial class ManageStyle : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        CommonFunctions.Setserial(gdvStyle, "srno");
        ...
        protected void btnStatus_Click(object sender, EventArgs e)
        {
            try
            {
                string StrStyleID = CommonFunctions.GetCheckedRow(gdvStyle, "chkSelect");
                if (StrStyleID != "")
                {
                    StoreFront ObjStoreFront = new StoreFront();
