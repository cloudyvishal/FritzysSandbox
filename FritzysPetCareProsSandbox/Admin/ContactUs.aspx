<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ContactUs" %>
            ...
            <table border="0" style="margin: 10px 0pt 0pt;">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:ImageButton ID="imgCalPop" runat="server" ImageUrl="http://localhost:50372/Images/calImage.jpg" />
                        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" PopupButtonID="imgCalPop"
                    ...
                    <td>
                        ...
                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="http://localhost:50372/Images/calImage.jpg" />
