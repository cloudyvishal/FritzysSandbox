    ...
    public partial class ManageNews : System.Web.UI.Page
    {
        ...
        public void BindGrid()
        {
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    CommonFunctions.Setserial(GrdNews, "srno");
        ...
        protected void btnStatus_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string UserID = CommonFunctions.GetCheckedRow(GrdNews, "chkSelect");
                if (UserID != "")
                {
                    Global ObjUser = new Global();
        ...
        protected void SaveFile(string StrContent)
        {
            try
            {
                string Fullpath = ConfigurationManager.AppSettings["HomePathValue"] + "StoreData/StaticeContent/" + "AboutUs.htm";
