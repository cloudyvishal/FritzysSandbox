<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AppointmentDateSetting.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.AppointmentDateSetting" %>
                        ...
                        <table class="setservPage AppSettingTable" cellpadding="4" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td style="padding-top: 7px;">
                                    ...
                                    <br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date:<asp:TextBox ID="txtDate" onkeypress="return false;" runat="server" CssClass="regTextField" Width="120px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
