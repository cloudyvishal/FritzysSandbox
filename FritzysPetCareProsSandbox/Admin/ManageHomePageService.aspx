<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageHomePageService.aspx.cs" Inherits="FritzysPetCareProsSandbox.Admin.ManageHomePageService" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="innerContent">
        <div class="pageTitle">
            <h2>Manage Home Page Services</h2>
        </div>
