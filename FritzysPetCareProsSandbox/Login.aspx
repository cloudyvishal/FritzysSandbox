            ...
            <div id="wrapper">
                ...
                <div id="mainInnerContent">
                    ...
                    <div id="innerLeftPannel">
                        ...
                        <div class="flashImg">
                            <asp:Image ID="aboutusbanner" ImageUrl="..//Images/aboutusBanner.jpg" runat="server" AlternateText=" " />

                        </div>
                        <div class="title">
                            <asp:Image ID="BlankTitle" ImageUrl="..//Images/content_shadow3.jpg" runat="server" AlternateText=" " />
                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="2" style="height: 17px">
                                                        <asp:ImageButton ID="btnLogin" runat="server" ToolTip="LOGIN" ImageUrl="../Images/loginbtn.jpg" ValidationGroup="valSuggest" OnClick="btnLogin_Click1" /></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <p>
                                                ...
                                                <tr>
                                                    <td colspan="2">Not a Member?&nbsp;&nbsp;<asp:ImageButton ID="RegisterNow" runat="server" ToolTip="REGISTER NOW" ImageUrl="http://localhost:50372/Images/regesterImg.jpg" ValidationGroup="valSuggest" /></td>
                                                </tr>
                    ...
                    <div id="innerRightPannel">
                        ...
                        <div class="img">
                            <div class="locationServiced">
                                ...
                                <div class="gobutton">
                                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="http://localhost:50372/Images/btn_go.gif"
                                        AlternateText="Go" />
                                </div>
                            </div>
                            <div class="img">
                                <a href="#" title="It's Free Join Fritzy's Club">
                                    <img src="http://localhost:50372/Images/join_fritzys_club.jpg" border="0" alt="It's Free Join Fritzy's Club" /></a>
                            </div>
                            <div class="img">
                                <a href="#" title="Make an appointment Now">
                                    <img src="http://localhost:50372/Images/make_appointment_now.jpg" border="0" alt="Make an appointment Now" /></a>
                            </div>
                            <div class="imgGiftcard">
                                <a href="#" title="Fritzy's giftcard">
                                    <img src="http://localhost:50372/Images/giftcard1.jpg" border="0" alt="Fritzy's GiftCard" /></a>
                            </div>
                            <div class="img">
                            ...
                            <div class="img">
                                <div class="sugesstionBox">
                                    <asp:ImageButton ID="btnSuggestion" runat="server" ImageUrl="http://localhost:50372/Images/btn_suggestion_box_bg.jpg" />
    ...
    <asp:Panel Style="display: none" ID="PanelFiveImg" runat="server">
        <table width="200px" border="1">
            <tbody>
                <tr>
                    <td align="right">
                        <asp:ImageButton ID="closewindow" ImageUrl="http://localhost:50372/Images/closeImg.jpg" runat="server" CausesValidation="false" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:ImageButton ID="btnSumbmit" runat="server" OnClick="btnSumbmit_Click" ImageUrl="http://localhost:50372/Images/submitbutton.jpg"
