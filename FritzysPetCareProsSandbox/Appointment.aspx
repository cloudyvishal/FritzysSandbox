<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="Appointment.aspx.cs" Inherits="FritzysPetCareProsSandbox.Appointments" %>
            ...
            <div id="wrapper">
                ...
                <div id="mainInnerContent">
                    ...
                    <div id="regMain">
                        ...
                        <div id="regTitle">
                            <asp:Image ID="ImgScheduled" ImageUrl="http://localhost:50372/Images/regScheduleTitle.jpg" runat="server" />
                        </div>
                            ...
                            <div class="regFormMid">
                                <div class="ApptForm" onkeypress="javascript:return FormPanel_FireDefaultButton(event,'ctl00_ContentPlaceHolder1_IdNext')">
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Image ID="IdWhoWhat" ImageUrl="http://localhost:50372/Images/reg_who_what_title.jpg" runat="server" /></td>
                                        </tr>
                                    </table>
                                    <table cellspacing="6" border="0">
                                        ...
                                        <tr id="p1" runat="server">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlBreed1" CssClass="regTextFldBread1Appt" runat="server">
                                                </asp:DropDownList>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPetDOB1" CssClass="regTextFldbyearAppoint" runat="server" MaxLength="4"></asp:TextBox>
                                                ...
                                                <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender6" TargetControlID="ReqPet4"
                                                ...
                                                <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender1" TargetControlID="custYear1"
                                                    HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtPetWeight1" CssClass="regTextFldstate" runat="server" MaxLength="6"></asp:TextBox>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPetLength1" MaxLength="6" CssClass="regTextFldflengthApp" runat="server"></asp:TextBox>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlStyle1" CssClass="regTextfldStyle" runat="server"></asp:DropDownList>
                                            </td>
                                            <td>
                                                <div>
                                                    ...
                                                    <asp:TextBox ID="txtAddServices1" runat="server" OnClick="return setList(1);" Text="Select Service" CssClass="regddlFldAdservice"></asp:TextBox>

                                                    <asp:ImageButton ID="ImgAdservices1" runat="server" ImageUrl="~/Images/DDImage.bmp" OnClientClick="return setList(1);" CssClass="imgbutton" />
                                                </div>
                                                <div class="apptDrpDiv">
                                                    <asp:ListBox ID="lstAddservices1" runat="server" CssClass="apptListbox" SelectionMode="Multiple" Style="display: none;"
                                                        OnClick="return SetText(1);" onblur="return HideList(1);"></asp:ListBox>
                                                </div>
                                            </td>
                                            <td>
                                                <asp:ImageButton ID="imgDelete1" runat="server" Visible="false"
                                                    ImageUrl="http://localhost:50372/Images/deleteicon.gif" ToolTip="Delete" OnClick="imgDelete1_Click" OnClientClick="return confirmation();" /></td>
                                        </tr>
                                        <tr id="p2" runat="server">
                                            <td>2.</td>

                                            <td>
                                                <asp:DropDownList ID="ddlPetType2" CssClass="regddlField" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType2_SelectedIndexChanged">
                                                    <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                                    <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtPetName2" CssClass="regTextFldpetnameAppoint" runat="server" MaxLength="20"></asp:TextBox>
                                                <asp:Label ID="PetID2" runat="server" Text="0" Visible="false"></asp:Label>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl21"
                                                    ControlToValidate="txtPetName2"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Pet name is required."
                                                    Display="None" ValidationGroup="valPet" runat="server" SetFocusOnError="true">  
                                                </asp:RequiredFieldValidator>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlBreed2" CssClass="regTextFldBread1Appt" runat="server"></asp:DropDownList>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl22"
                                                    Text="Selcect One"
                                                    InitialValue="0"
                                                    ControlToValidate="ddlBreed2"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Breed is required"
                                                    Display="none"
                                                    ValidationGroup="valPet" runat="server" SetFocusOnError="true" />
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtDOB2" CssClass="regTextFldbyearAppoint" runat="server" MaxLength="4"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl23"
                                                    ControlToValidate="txtDOB2"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Pet birth year is required."
                                                    Display="None" ValidationGroup="valPet" runat="server" SetFocusOnError="true">  
                                                </asp:RequiredFieldValidator>
                                                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender9" TargetControlID="ReqVAl23"
                                                    HighlightCssClass="validatorCalloutHighlight" Enabled="true" runat="Server" />
                                                <asp:RegularExpressionValidator ID="RegDOB2" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct birth year." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ControlToValidate="txtDOB2" ValidationExpression="\d{4}"></asp:RegularExpressionValidator>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPetWeight2" CssClass="regTextFldstate" runat="server" MaxLength="5"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl24"
                                                    ControlToValidate="txtPetWeight2"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Pet weight is required."
                                                    Display="None" ValidationGroup="valPet" runat="server" SetFocusOnError="true">  
                                                </asp:RequiredFieldValidator>
                                                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender11" TargetControlID="ReqVAl24"
                                                    HighlightCssClass="validatorCalloutHighlight" Enabled="true" runat="Server" />

                                                <asp:RegularExpressionValidator ID="RegWeight2" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct Weight." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ControlToValidate="txtPetWeight2" ValidationExpression="^\d*(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                                <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender12" TargetControlID="RegWeight2"
                                                    HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtPetLength2" CssClass="regTextFldflengthApp" runat="server" MaxLength="5"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl25"
                                                    ControlToValidate="txtPetLength2"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Fur length is required."
                                                    Display="None" ValidationGroup="valPet" runat="server" SetFocusOnError="true">  
                                                </asp:RequiredFieldValidator>
                                                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender13" TargetControlID="ReqVAl25"
                                                    HighlightCssClass="validatorCalloutHighlight" Enabled="true" runat="Server" />

                                                <asp:RegularExpressionValidator ID="ReqLength2" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct length." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ControlToValidate="txtPetLength2" ValidationExpression="^\d*(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlStyle2" CssClass="regTextfldStyle" runat="server"></asp:DropDownList>
                                            </td>
                                            <td>
                                                <div>
                                                    <div style="display: none;">
                                                    ...
                                                    <asp:TextBox ID="txtAddServices2" runat="server" Text="Select Service" OnClick="return setList(2);" CssClass="regddlFldAdservice"></asp:TextBox>
                                                    <asp:ImageButton ID="ImgAdservices2" runat="server" ImageUrl="~/Images/DDImage.bmp" OnClientClick="return setList(2);" CssClass="imgbutton" />
                                                </div>
                                                <div class="apptDrpDiv">
                                                    <asp:ListBox ID="lstAddservices2" runat="server" CssClass="apptListbox" SelectionMode="Multiple" Style="display: none;"
                                                        OnClick="return SetText(2);" onblur="return HideList(2);"></asp:ListBox>
                                                </div>
                                            </td>
                                            <td>
                                                <asp:ImageButton ID="imgDelete2" runat="server" Visible="false"
                                                    ImageUrl="~/Images/deleteicon.gif" ToolTip="Delete" OnClick="imgDelete2_Click" OnClientClick="return confirmation();" /></td>
                                        </tr>

                                        <tr id="p3" runat="server">
                                            <td>3.</td>
                                            <td>
                                                <asp:DropDownList ID="ddlPetType3" CssClass="regddlField" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType3_SelectedIndexChanged">
                                                    <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                                    <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtPetName3" CssClass="regTextFldpetnameAppoint" runat="server" MaxLength="30"></asp:TextBox>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlBreed3" CssClass="regTextFldBread1Appt" runat="server"></asp:DropDownList>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl32"
                                                    Text="Selcect One"
                                                    InitialValue="0"
                                                    ControlToValidate="ddlBreed3"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Breed is required"
                                                    Display="none"
                                                    ValidationGroup="valPet" runat="server" SetFocusOnError="true" />
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtDOB3" CssClass="regTextFldbyearAppoint" runat="server" MaxLength="4"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAL33"
                                                ...
                                                <asp:RegularExpressionValidator ID="RegDOB3" ControlToValidate="txtDOB3" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct birth year." ValidationGroup="valPet"
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPetWeight3" CssClass="regTextFldstate" runat="server" MaxLength="5"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl34"
                                                ...
                                                <asp:RegularExpressionValidator ID="RegWeight3" ControlToValidate="txtPetWeight3" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct Weight." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ValidationExpression="^\d*(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                                <cc1:ValidatorCalloutExtender runat="Server" ID="ValidatorCalloutExtender20" TargetControlID="RegWeight3"
                                                    HighlightCssClass="validatorCalloutHighlight" Enabled="true" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtPetLength3" CssClass="regTextFldflengthApp" runat="server" MaxLength="5"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAL35"
                                                ...
                                                <asp:RegularExpressionValidator ID="ReqLength3" ControlToValidate="txtPetLength3" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct length." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ValidationExpression="^\d*(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlStyle3" CssClass="regTextfldStyle" runat="server"></asp:DropDownList>
                                            </td>
                                            <td>
                                                <div>
                                                    <div style="display: none;">
                                                    ...
                                                    <asp:TextBox ID="txtAddServices3" runat="server" Text="Select Service" OnClick="return setList(3);" CssClass="regddlFldAdservice"></asp:TextBox>
                                                    <asp:ImageButton ID="ImgAdservices3" runat="server" ImageUrl="~/Images/DDImage.bmp" OnClientClick="return setList(3);" CssClass="imgbutton" />
                                                </div>
                                                <div class="apptDrpDiv">
                                                    <asp:ListBox ID="lstAddservices3" runat="server" CssClass="apptListbox" SelectionMode="Multiple" Style="display: none;"
                                                        OnClick="return SetText(3);" onblur="return HideList(3);"></asp:ListBox>
                                                </div>
                                            </td>
                                            <td>
                                                <asp:ImageButton ID="imgDelete3" runat="server" Visible="false"
                                                    ImageUrl="http://localhost:50372/Images/deleteicon.gif" ToolTip="Delete" OnClick="imgDelete3_Click" OnClientClick="return confirmation();" /></td>
                                        </tr>
                                        <tr id="p4" runat="server">
                                            <td>4.</td>
                                            <td>
                                                <asp:DropDownList ID="ddlPetType4" CssClass="regddlField" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType4_SelectedIndexChanged">
                                                    <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                                    <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtPetName4" CssClass="regTextFldpetnameAppoint" runat="server" MaxLength="30"></asp:TextBox>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlBreed4" CssClass="regTextFldBread1Appt" runat="server"></asp:DropDownList>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl42"
                                                    Text="Selcect One"
                                                    InitialValue="0"
                                                    ControlToValidate="ddlBreed4"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Breed is required"
                                                    Display="none"
                                                    ValidationGroup="valPet" runat="server" SetFocusOnError="true" />
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtDOB4" CssClass="regTextFldbyearAppoint" runat="server" MaxLength="4"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAL43"
                                                ...
                                                <asp:RegularExpressionValidator ID="RegDOB4" ControlToValidate="txtDOB4" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct birth year." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ValidationExpression="\d{4}"></asp:RegularExpressionValidator>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPetWeight4" CssClass="regTextFldstate" runat="server" MaxLength="5"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl44"
                                                ...
                                                <asp:RegularExpressionValidator ID="RegWeight4" ControlToValidate="txtPetWeight4" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct Weight." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ValidationExpression="^\d*(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPetLength4" CssClass="regTextFldflengthApp" runat="server" MaxLength="5"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAL45"
                                                ...
                                                <asp:RegularExpressionValidator ID="ReqLength4" ControlToValidate="txtPetLength4" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct length." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ValidationExpression="^\d*(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlStyle4" CssClass="regTextfldStyle" runat="server"></asp:DropDownList>
                                            </td>
                                            <td>
                                                <div>
                                                    <div style="display: none;">
                                                    ...
                                                    <asp:TextBox ID="txtAddServices4" runat="server" Text="Select Service" OnClick="return setList(4);" CssClass="regddlFldAdservice"></asp:TextBox>
                                                    <asp:ImageButton ID="ImgAdservices4" runat="server" ImageUrl="http://localhost:50372/Images/DDImage.bmp" OnClientClick="return setList(4);" CssClass="imgbutton" />
                                                </div>
                                                <div class="apptDrpDiv">
                                                    <asp:ListBox ID="lstAddservices4" runat="server" CssClass="apptListbox" SelectionMode="Multiple" Style="display: none;"
                                                        OnClick="return SetText(4);" onblur="return HideList(4);"></asp:ListBox>
                                                </div>
                                            </td>
                                            <td>
                                                <asp:ImageButton ID="imgDelete4" runat="server" Visible="false"
                                                    ImageUrl="http://localhost:50372/Images/deleteicon.gif" ToolTip="Delete" OnClick="imgDelete4_Click" OnClientClick="return confirmation();" /></td>
                                        </tr>

                                        <tr id="p5" runat="server">
                                            <td>5.</td>
                                            <td>
                                                <asp:DropDownList ID="ddlPetType5" CssClass="regddlField" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType5_SelectedIndexChanged">
                                                    <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                                    <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtPetName5" CssClass="regTextFldpetnameAppoint" runat="server" MaxLength="30"></asp:TextBox>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlBreed5" CssClass="regTextFldBread1Appt" runat="server"></asp:DropDownList>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl52"
                                                    Text="Selcect One"
                                                    InitialValue="0"
                                                    ControlToValidate="ddlBreed5"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Breed is required"
                                                    Display="none"
                                                    ValidationGroup="valPet" runat="server" SetFocusOnError="true" />
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtDOB5" CssClass="regTextFldbyearAppoint" runat="server" MaxLength="4"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAL53"
                                                ...
                                                <asp:RegularExpressionValidator ID="RegDOB5" ControlToValidate="txtDOB5" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct birth year." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ValidationExpression="\d{4}"></asp:RegularExpressionValidator>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPetWeight5" CssClass="regTextFldstate" runat="server" MaxLength="5"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl54"
                                                ...
                                                <asp:RegularExpressionValidator ID="RegWeight5" ControlToValidate="txtPetWeight5" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct Weight." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ValidationExpression="^\d*(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPetLength5" CssClass="regTextFldflengthApp" runat="server" MaxLength="5"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAL55"
                                                ...
                                                <asp:RegularExpressionValidator ID="ReqLength5" ControlToValidate="txtPetLength5" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct length." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ValidationExpression="^\d*(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlStyle5" CssClass="regTextfldStyle" runat="server"></asp:DropDownList>
                                            </td>
                                            <td>
                                                <div>
                                                    <div style="display: none;">
                                                    ...
                                                    <asp:TextBox ID="txtAddServices5" runat="server" Text="Select Service" OnClick="return setList(5);" CssClass="regddlFldAdservice"></asp:TextBox>
                                                    <asp:ImageButton ID="ImgAdservices5" runat="server" ImageUrl="http://localhost:50372/Images/DDImage.bmp" OnClientClick="return setList(5);" CssClass="imgbutton" />
                                                </div>
                                                <div class="apptDrpDiv">
                                                    <asp:ListBox ID="lstAddservices5" runat="server" CssClass="apptListbox" SelectionMode="Multiple" Style="display: none;"
                                                        OnClick="return SetText(5);" onblur="return HideList(5);"></asp:ListBox>
                                                </div>
                                            </td>
                                            <td>
                                                <asp:ImageButton ID="imgDelete5" runat="server" Visible="false"
                                                    ImageUrl="http://localhost:50372/Images/deleteicon.gif" ToolTip="Delete" OnClick="imgDelete5_Click" OnClientClick="return confirmation();" /></td>
                                        </tr>
                                        <tr id="p6" runat="server">
                                            <td>6.</td>
                                            <td>
                                                <asp:DropDownList ID="ddlPetType6" CssClass="regddlField" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPetType6_SelectedIndexChanged">
                                                    <asp:ListItem Text="Cat" Value="0"></asp:ListItem>
                                                    <asp:ListItem Text="Dog" Value="1"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtPetName6" CssClass="regTextFldpetnameAppoint" runat="server" MaxLength="20"></asp:TextBox>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlBreed6" CssClass="regTextFldBread1Appt" runat="server"></asp:DropDownList>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl62"
                                                    Text="Selcect One"
                                                    InitialValue="0"
                                                    ControlToValidate="ddlBreed6"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Breed is required"
                                                    Display="none"
                                                    ValidationGroup="valPet" runat="server" SetFocusOnError="true" />
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtDOB6" CssClass="regTextFldbyearAppoint" runat="server" MaxLength="4"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAL63"
                                                ...
                                                <asp:RegularExpressionValidator ID="RegDOB6" ControlToValidate="txtDOB6" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct birth year." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ValidationExpression="\d{4}"></asp:RegularExpressionValidator>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPetWeight6" CssClass="regTextFldstate" runat="server" MaxLength="5"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAl64"
                                                ...
                                                <asp:RegularExpressionValidator ID="RegWeight6" ControlToValidate="txtPetWeight6" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct Weight." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ValidationExpression="^\d*(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPetLength6" CssClass="regTextFldflengthApp" runat="server" MaxLength="5"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                                    ID="ReqVAL65"
                                                ...
                                                <asp:RegularExpressionValidator ID="ReqLength6" ControlToValidate="txtPetLength6" runat="server" Display="None"
                                                    ErrorMessage="<b>Required Field Missing</b><br />Please enter correct length." ValidationGroup="valPet"
                                                    SetFocusOnError="true" ValidationExpression="^\d*(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlStyle6" CssClass="regTextfldStyle" runat="server"></asp:DropDownList>
                                            </td>
                                            <td>
                                                <div>
                                                    <div style="display: none;">
                                                    ...
                                                    <asp:TextBox ID="txtAddServices6" runat="server" Text="Select Service" OnClick="return setList(6);" CssClass="regddlFldAdservice"></asp:TextBox>
                                                    <asp:ImageButton ID="ImgAdservices6" runat="server" ImageUrl="http://localhost:50372/Images/DDImage.bmp" OnClientClick="return setList(6);" CssClass="imgbutton" />
                                                </div>
                                                <div class="apptDrpDiv">
                                                    <asp:ListBox ID="lstAddservices6" runat="server" CssClass="apptListbox" SelectionMode="Multiple" Style="display: none;"
                                                        OnClick="return SetText(6);" onblur="return HideList(6);"></asp:ListBox>
                                                </div>
                                            </td>
                                            <td>
                                                <asp:ImageButton ID="imgDelete6" runat="server" Visible="false"
                                                    ImageUrl="~/Images/deleteicon.gif" ToolTip="Delete" OnClick="imgDelete6_Click" OnClientClick="return confirmation();" /></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="8">
                                                <asp:Label ID="lblMessageSix" runat="server" Visible="false"></asp:Label>
                                                <asp:ImageButton ID="imgAddmore" ImageUrl="http://localhost:50372/Images/regAddpetbtn.jpg" runat="server" OnClick="imgAddmore_Click" CausesValidation="true" ValidationGroup="valPet" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="8">
                                                <asp:ImageButton ID="ImageButton1" ImageUrl="http://localhost:50372/Images/regEDitbtn.jpg" runat="server" OnClick="ImageButton3_Click" /></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td colspan="8">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Image ID="ImgWhenTitle" runat="server" ImageUrl="http://localhost:50372/Images/reg_when_title.jpg" /></td>
                                    </tr>
                                    </table>
                                    ...
                                    <table class="calendertable">
                                        <tr>
                                            <td colspan="2" class="paddingforcalender">
                                                ...
                                                <asp:ImageButton ID="imgCalPop" runat="server" ImageUrl="http://localhost:50372/Images/calImage.jpg" Visible="false" />
                                                ...
                                                <asp:TextBox ID="txtDate" runat="server" Width="0px" Height="0px" CssClass="dateTxt" Text="01/01/2009"></asp:TextBox>

                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="appointtd">
                                                <label>Date</label><span>*</span></td>
                                            <td style="width: 214px">
                                                <asp:TextBox ID="txtSelectDate" ReadOnly="true" CssClass="regTextFldpetnameAppoint" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="appointtd">
                                                <label>Time</label><span>*</span></td>
                                            <td style="width: 214px">
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Image ID="Image1" runat="server" ImageUrl="http://localhost:50372/Images/reg_where_title.jpg" /></td>
                                        </tr>
                                    </table>
                                    <table cellspacing="8">
                                        <tr>
                                            <td>
                                                ...
                                                <br />
                                                <asp:TextBox Height="60px" Rows="5" Columns="20" TextMode="MultiLine" ID="txtPrimary" CssClass="appTextFldprimary" runat="server" onkeyDown="checkTextAreaMaxLength(this,event,'99');"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:RadioButton ID="red2" runat="server" Text="Alternate Address" onClick="return setred2();" />
                                                <br />
                                                <asp:TextBox Height="60px" Rows="5" Columns="20" TextMode="MultiLine" ID="txtAlternat" CssClass="appTextFldAlternate" runat="server" onkeyDown="checkTextAreaMaxLength(this,event,'99');"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Image ID="Image2" runat="server" ImageUrl="http://localhost:50372/Images/reg_confirmby.jpg" /></td>
                                        </tr>
                                    </table>
                                    <table cellspacing="8">
                                        <tr>
                                            <td>
                                                <asp:RadioButtonList ID="redConfirmBy" runat="server" RepeatDirection="Horizontal" Width="200px">
                                                    <asp:ListItem Text="Email" Value="0" Selected="True"></asp:ListItem>
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Image ID="Image3" runat="server" ImageUrl="http://localhost:50372/Images/reg_notes.jpg" /></td>
                                        </tr>
                                    </table>
                                    <table cellspacing="8">
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="idtextarea" Rows="5" Columns="20" TextMode="MultiLine"
                                                    CssClass="appTextFldTextArea" runat="server"
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="left" style="padding-left: 5px;">
                                                <asp:ImageButton ID="IdNext" ImageUrl="http://localhost:50372/Images/regScheduleBtn.jpg" runat="server" OnClick="IdNext_Click" />
                                            ...
                                            <td align="right" style="padding-right: 10px;">
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tdstylemendtory" align="left"><span>*</span>&nbsp;required</td>
                                                    </tr>
                                                    <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntFooter" runat="server">
    <script type="text/javascript" lang="javascript">
        function setList(i) {
            if (document.getElementById("ctl00_cntBody_lstAddservices" + i).style.display == "none") {
                document.getElementById("ctl00_cntBody_lstAddservices" + i).style.display = "block";
                document.getElementById("ctl00_cntBody_lstAddservices" + i).focus();
            }
            else {
                document.getElementById("ctl00_cntBody_lstAddservices" + i).style.display = "none";
            }
            return false;
        }
        function HideList(i) {
        ...
        function SetText(i) {
            var Source = document.getElementById("ctl00_cntBody_lstAddservices" + i);
            var str = "";
            var str1 = "";
            //alert(Source.options.selectedIndex);
            for (j = 0; j < document.getElementById("ctl00_cntBody_lstAddservices" + i).length; j++) {
            ...
            document.getElementById("ctl00_cntBody_txtAddServices" + i).value = str;
            document.getElementById("ctl00_cntBody_txtAddServicesID" + i).value = str1;
        }
    </script>
    <script type="text/javascript" lang="javascript">
    ...
    <script type="text/javascript" lang="javascript" defer="defer">
        ...
        function SetAddress() {
            alert(document.getElementById("ctl00_cntBody_redlist_1").Value);
