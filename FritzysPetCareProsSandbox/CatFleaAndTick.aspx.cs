...
{
    public partial class CatFleaAndTick : BasePage
    {
        int ServiceId = 49;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        Response.Redirect("http://localhost:50372/fritzymobile/Cat_Flea_and_Tick.aspx".ToLower());

                        HttpContext.Current.Response.Status = "301 Moved Permanently";

                        HttpContext.Current.Response.AddHeader("Location", Request.Url.ToString().Replace("http://localhost:50372/", "http://www.localhost:50372/fritzymobile/Cat_Flea_and_Tick.aspx"));
