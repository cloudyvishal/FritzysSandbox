            ...
            <div id="wrapper">
                ...
                <div id="mainInnerContent">
                    ...
                    <div id="innerLeftPannel">
                        ...
                        <div class="title">
                            <asp:Image ID="fritzyfriendtitle" ImageUrl="http://localhost:50372/Images/fritzyfriendTitle.jpg" runat="server"
                                AlternateText="" />
                        </div>
                        <div class="leftInner">
                            <div class="aboutinnerleft">
                                <asp:Image ID="leftimage" ImageUrl="http://localhost:50372/Images/fritzyfriendleft.jpg" runat="server"
                                    AlternateText="" />
                            </div>
                        ...
                        <div class="title">
                            <asp:Image ID="blanktitle" ImageUrl="http://localhost:50372/Images/pageTitle.jpg" runat="server" AlternateText="" />
                        </div>
                        <div class="leftInner">
                            <div class="petcareBg">
