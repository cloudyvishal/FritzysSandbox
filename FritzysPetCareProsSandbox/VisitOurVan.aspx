<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="VisitOurVan.aspx.cs" Inherits="FritzysPetCareProsSandbox.VisitOurVan" %>
            ...
            <div id="wrapper">
                ...
                <div id="mainInnerContent">
                    ...
                    <div id="innerLeftPannel">
                        ...
                        <div class="title">
                            <asp:Image ID="vantitle" ImageUrl="http://localhost:50372/Images/vanTitle.jpg" runat="server" Style=""
                                AlternateText="" />
                        </div>
                        <div class="vanleftInner">
                            <div class="vanInner">
                                <div id="slideshow" style="width: 100%; background: none;">
                                    <img src="http://localhost:50372/StoreData/VisitVan/2.jpg" />
                                </div>
                            ...
                            <div class="title">
                                <asp:Image ID="vanImgShadow" ImageUrl="http://localhost:50372/Images/vanImgShadow.jpg" runat="server"
                                    AlternateText="" />
                            </div>
                            <div class="leftInner">
                                <div class="vanTitle">
                                    <asp:Image ID="fullsalonheader" ImageUrl="http://localhost:50372/Images/fullsalonHeader.jpg" runat="server"
                                        AlternateText="" />
                                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntFooter" runat="server">
     <script type="text/javascript" language="javascript">
         ...
         var def_imges1 = new Array('http://localhost:50372/StoreData/VisitVan/2.jpg', 'http://localhost:50372/StoreData/VisitVan/3.jpg', 'http://localhost:50372/StoreData/VisitVan/4.jpg');
         //****************************************************************
         ...
         function be_slideshow(be_slideid, be_imges, be_divid, be_picwid, be_pichei, be_backgr, be_sdur, be_fdur, be_steps, be_startwhen, be_shuffle, be_showcontr, be_contr) {
             ...
             this.b_insert = function () {
                 ...
                 for (b = 1; b <= emax; b++) {
                     ...
                     myhtml += "<img src='" + def_imges1[(b - 2)] + "' style='vertical-align:middle;border:0;' alt=''/></div>";
                 }
                 myhtml += "</div>";
                 //show controls
                 if (showcontr) {
                     for (b = 1; b <= 4; b++) {
                         ...
                         contr[b - 1] = (check == "jpg" || check == "gif" || check == "png") ? ("<img src='" + def_imges1[b - 2] + "' style='border:none;' alt=''/>") : (contr[b - 1]);
                     }
